Locales["sv"] = {
	...
	["callsignsuggestion"] = "Ändra ditt rakelnummer",
	["callsignhelp"] = "Rakelnummer",
	...
	ui = {
		...
		messages = {
			...
			input = "Skriv något...",
			empty =
			"Det verkar som att du inte har några kontakter.<br/>Du kan lägga till kontakter via radio medlemms listan.",
		...
		channels = {
			...
			removeFavorite = "Radera kanal",
			removeRecent = "Radera kanal",
			new = "Ny favorit",
			frequency = "Frekvens",
		},
		...
		radioMembers = {
			...
			-- {0} = Player name
			-- {1} = Player callsign, if present
			nameWithCallsign = "{0} ({1})",
			nameWithoutCallsign = "{0}",
		},
		...
		info = {
			...
			inRadio = "I en radio",
			-- used for forexample the current frequency
			hiddenByStreamerMode = "****"
		},
	},
}
