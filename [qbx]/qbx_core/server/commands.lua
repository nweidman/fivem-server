...
lib.addCommand('tpm', {
    ...
    local logMsg = ('**ADMIN**\n**Admin:** %s\n**Character Name:** %s\n**Citizen ID:** %s\n**License:** %s\n\n**LOCATION**\n**Coords: **%s'):format(GetPlayerName(source), Player.PlayerData.charinfo.firstname .. " " .. Player.PlayerData.charinfo.lastname, Player.PlayerData.citizenid, Player.PlayerData.license, tostring(playerCoords))
    TriggerEvent('qb-log:server:CreateLog', 'admin_tpm', '🌍 /tpm', 'white', logMsg, false)
end)
...
lib.addCommand('car', {
    ...
    local logMsg = ('**ADMIN**\n**Name:** %s\n**Character Name: **%s\n**Citizen ID: **%s\n**License:** %s\n\n**VEHICLE**\n**Name: **%s'):format(
        ...
        args[locale('command.car.params.model.name')]
    )
    TriggerEvent('qb-log:server:CreateLog', 'admin_car', '🚘 /car', 'white', logMsg, false)
...
lib.addCommand('dv', {
    ...
    if vehicle then
        ...
        plate = GetVehicleNumberPlateText(pedCars[1])
    end
    local Player = exports.qbx_core:GetPlayer(source)
    if #pedCars ~= 0 then
        for i = 1, #pedCars do
    ...
    TriggerEvent('qb-log:server:CreateLog', 'admin_dv', '🪄 /dv', 'white', logMsg, false)
end)
...
lib.addCommand('givemoney', {
    ...
    player.Functions.AddMoney(args[locale('command.givemoney.params.moneytype.name')], args[locale('command.givemoney.params.amount.name')], 'admin give money')
    local logMsg = ('**ADMIN**\n**Name:** %s\n**Character Name:** %s\n**Citizen ID: **%s\n**License: **%s\n\n**TARGET**\n**Name:** %s\n**Character Name:** %s\n**Citizen ID: **%s\n**License: **%s\n\n**MONEY**\n**Account:** %s\n**Amount:** $%s\n'):format(
                    GetPlayerName(source), 
                    Player.PlayerData.charinfo.firstname .. " " .. Player.PlayerData.charinfo.lastname, 
                    Player.PlayerData.citizenid, 
                    ...
                    player.PlayerData.citizenid, 
                    player.PlayerData.license,
                    args[locale('command.givemoney.params.moneytype.name')], 
                    args[locale('command.givemoney.params.amount.name')]
                )
        TriggerEvent('qb-log:server:CreateLog', 'admin_givemoney', '🤑 /givemoney', 'green', logMsg, false)
end)
...
lib.addCommand('setmoney', {
    ...
    local logMsg = ('**ADMIN**\n**Name:** %s\n**Character Name:** %s\n**Citizen ID: **%s\n**License: **%s\n\n**TARGET**\n**Name:** %s\n**Character Name:** %s\n**Citizen ID: **%s\n**License: **%s\n\n**MONEY**\n**Account:** %s\n**Amount:** $%s\n'):format(
        ...
        TriggerEvent('qb-log:server:CreateLog', 'admin_setmoney', '🤑 /setmoney', 'green', logMsg, false)
end)


lib.addCommand('removemoney', {
    help = "Remove a Player's Money (Admin Only)",
    params = {
        { name = locale('command.givemoney.params.id.name'), help = locale('command.givemoney.params.id.help'), type = 'playerId' },
        { name = locale('command.givemoney.params.moneytype.name'), help = locale('command.givemoney.params.moneytype.help'), type = 'string' },
        { name = locale('command.givemoney.params.amount.name'), help = locale('command.givemoney.params.amount.help'), type = 'number' }
    ...
    local Player = GetPlayer(source)
    player.Functions.RemoveMoney(args[locale('command.givemoney.params.moneytype.name')], args[locale('command.givemoney.params.amount.name')], 'admin remove money')
    local logMsg = ('**ADMIN**\n**Name:** %s\n**Character Name:** %s\n**Citizen ID: **%s\n**License: **%s\n\n**TARGET**\n**Name:** %s\n**Character Name:** %s\n**Citizen ID: **%s\n**License: **%s\n\n**MONEY**\n**Account:** %s\n**Amount:** $%s\n'):format(
                    GetPlayerName(source), 
                    Player.PlayerData.charinfo.firstname .. " " .. Player.PlayerData.charinfo.lastname, 
                    Player.PlayerData.citizenid, 
        ...
        TriggerEvent('qb-log:server:CreateLog', 'admin_givemoney', '🤑 /removemoney', 'red', logMsg, false)
end)
...
lib.addCommand('setjob', {
    ...
    local logMsg = ('**ADMIN**\n**Name:** %s\n**Character Name:** %s\n**Citizen ID: **%s\n**License: **%s\n\n**TARGET**\n**Name:** %s\n**Character Name:** %s\n**Citizen ID: **%s\n**License: **%s\n\n**JOB**\n**Name:** %s\n**Grade:** %s\n'):format(
                    ...
                    player.PlayerData.citizenid, 
                    player.PlayerData.license, 
                    args[locale('command.setjob.params.job.name')],
                    args[locale('command.setjob.params.grade.name')] or 0
                )
    TriggerEvent('qb-log:server:CreateLog', 'admin_setjob', '👤 /setjob', 'green', logMsg, false)
end)
...
lib.addCommand('addjob', {
    ...
    local logMsg = ('**ADMIN**\n**Name:** %s\n**Character Name:** %s\n**Citizen ID: **%s\n**License: **%s\n\n**TARGET**\n**Name:** %s\n**Character Name:** %s\n**Citizen ID: **%s\n**License: **%s\n\n**JOB**\n**Name:** %s\n**Grade:** %s\n'):format(
                    ...
                    player.PlayerData.citizenid, 
                    player.PlayerData.license, 
                    args[locale('command.addjob.params.job.name')],
                    args[locale('command.addjob.params.grade.name')] or 0
                )
    TriggerEvent('qb-log:server:CreateLog', 'admin_setjob', '👤 /addjob', 'green', logMsg, false)
end)
...
lib.addCommand('removejob', {
    ...
    TriggerEvent('qb-log:server:CreateLog', 'admin_setjob', '👤 /removejob', 'red', logMsg, false)
end)
...
lib.addCommand('setgang', {
    ...
    local logMsg = ('**ADMIN**\n**Name:** %s\n**Character Name:** %s\n**Citizen ID: **%s\n**License: **%s\n\n**TARGET**\n**Name:** %s\n**Character Name:** %s\n**Citizen ID: **%s\n**License: **%s\n\n**JOB**\n**Name:** %s\n**Grade:** %s\n'):format(
                    ...
                    player.PlayerData.citizenid, 
                    player.PlayerData.license, 
                    args[locale('command.setgang.params.gang.name')],
                    args[locale('command.setgang.params.grade.name')] or 0
                )
    TriggerEvent('qb-log:server:CreateLog', 'admin_setjob', '👤 /setgang', 'green', logMsg, false)
end)
...
lib.addCommand('me', {
    ...
    local Plyer = GetPlayer(source)
    TriggerEvent('qb-log:server:CreateLog', 'me', '/me', 'white', '**' .. GetPlayerName(source) .. '** (CitizenID: ' .. Plyer.PlayerData.citizenid .. ' | ID: ' .. source .. ') **Message:** ' .. msg, false)
...
lib.addCommand('entitylaser', {
    help = 'toggle entity laser (admin only)',
    restricted = 'group.mod'
}, function(source)
    TriggerClientEvent('qbx_custom:toggleentitylaser', source)
end)