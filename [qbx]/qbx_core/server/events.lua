...
AddEventHandler('playerDropped', function(reason)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'joinleave', 'Player Dropped', 'red', logMsg)
    local logsTable = {
        ...
        ["joinleave"] = "leave", -- This could be a Lua variable in your script
        ["reason"] = reason,
        ["location"] = "<"..string.format("%.2f", pcoords.x)..", "..string.format("%.2f", pcoords.y)..", "..string.format("%.2f", pcoords.z)..">", -- This could be a Lua variable in your script
    }
