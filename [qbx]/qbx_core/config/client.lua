return {
    ...
    pauseMapText = 'OFF SZN', -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
    ...
    discord = {
        ...
        largeIcon = { -- To set this up, visit https://forum.cfx.re/t/how-to-updated-discord-rich-presence-custom-image/157686
            icon = '', -- Here you will have to put the image name for the 'large' icon.
            text = 'Playing  RP', -- Here you can add hover text for the 'large' icon.
        },

        smallIcon = {
            icon = '', -- Here you will have to put the image name for the 'small' icon.
            text = ' RP', -- Here you can add hover text for the 'small' icon.
        },
