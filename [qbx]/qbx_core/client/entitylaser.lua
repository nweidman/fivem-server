...
local GetEntityInfo = function(entity)
    ...
    local entityData    = {
        ...
        "Net ID:"..' ~y~'..(NetworkGetEntityIsNetworked(entity) and NetworkGetNetworkIdFromEntity(entity) or "Not registered"),
    ...
    if entityType == 1 then
        ...
        table.insert(entityData, "Armor:"..' ~y~'..GetPedArmour(entity))
        table.insert(entityData, "Relation Group:"..' ~y~'.. (Entities[pedRelationshipGroup] or "Custom Relationship"))
    ...
    elseif entityType == 2 then
        ...
        table.insert(entityData, (useKph and "Kph:" or "Mph:")..' ~y~'..RoundFloat((GetEntitySpeed(entity)*(useKph and 3.6 or 2.23694)), 0))
    ...
    table.insert(entityData, "Dist:"..' ~y~'.. RoundFloat(#(playerCoords-entityCoords), 2))
            ...
            if EntityFreeAim then
                ...
                if hit and (IsEntityAVehicle(entity) or IsEntityAPed(entity) or IsEntityAnObject(entity)) then
                    ...
                    if IsControlJustReleased(0, 47) then -- Freeze entities
                        ...
                        exports.qbx_core:Notify("You have "..(FrozenEntities[entity] and "Frozen" or "Unfrozen").. " the freeaim entity", (FrozenEntities[entity] and 'success' or 'error'))
                    end
                    ...
                    if IsControlJustReleased(0, 38) then -- Delete entity
                        ...
                        if not DoesEntityExist(entity) then
                            exports.qbx_core:Notify('Entity Deleted', 'success')
                        else
                            exports.qbx_core:Notify('Error Deleting Entity', 'error')
                        end
                    end
                else
                    FreeAimEntity = nil
...
RegisterNetEvent('qbx_custom:toggleentitylaser', function()
    ToggleEntityFreeView()
    if EntityFreeAim then
        exports.qbx_core:Notify("Entity Laser Enabled", "success")
    else
        exports.qbx_core:Notify("Entity Laser Disabled", "error")
    end
end)