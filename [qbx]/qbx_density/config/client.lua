return {
    ...
    vehicle = 0.50, -- Density of vehicles
    randomvehicles = 0.65, -- Density of random vehicles
    peds = 0.5, -- Density of random peds (civilians, etc.)
    scenario = 0.5, -- Density of scenario peds (bikers, gangsters, etc.)
}