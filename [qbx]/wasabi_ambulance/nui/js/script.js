...
const elements = {
    ...
    minuteHundreds: document.getElementById('minute-hundreds'),
    minuteHundredsBox: document.getElementById('minute-hundreds-box'),
...
const displayScreenThree = (data, color) => {
    ...
    if (minutes >= 100) {
    elements.minuteHundredsBox.style.display = "flex";
    elements.minuteHundreds.innerHTML = Math.floor(minutes / 100);
    elements.minuteTens.innerHTML = Math.floor((minutes % 100) / 10);
    elements.minuteOnes.innerHTML = minutes % 10;
    } else {
        elements.minuteHundredsBox.style.display = "none";
...
window.addEventListener('message', (event) => {
    ...
    if (event.data.action === "updateEmsOnline") {
        translationStrings = event.data.translationStrings;
        elements.online.innerHTML = translationStrings.currently_online + (event.data.emsOnline || 0);
