...
Strings = {
    ...
    log_combatlog_desc =
    '> %s [%s] combat log \n\n**Player Information:**\nName: `%s`\nPlayer ID: `%s`\nIdentifier: `%s`\nSteam: `%s`\nDiscord: `%s`\nLicense: `%s`\nLicense2: `%s`\nXBL: `%s`\nFiveM: `%s`\nIP: ||%s||',
    log_help_logs = 'Help Logs',
    log_helplog_title = 'Help Log',
    log_helplog_desc =
    '> %s [%s] help log \n\n**Player Information:**\nName: `%s`\nPlayer ID: `%s`\nIdentifier: `%s`\nSteam: `%s`\nDiscord: `%s`\nLicense: `%s`\nLicense2: `%s`\nXBL: `%s`\nFiveM: `%s`\nIP: ||%s||',
    ...
    checkin_hospital_desc = 'You have been successfully treated by the hospital staff',
...
UIStrings = {
    ...
    player_hurt_find_help_or_ems = "Press <span class='color'>G</span> to request emergency services - /HELP FOR LOCAL EMS",
    player_hurt_time_to_live = "Bleeding out",
    player_hurt_auto_respawn = "Vitals fading",
    player_hurt_respawn = "Hold E for 5 seconds to see the light and lose all items",
