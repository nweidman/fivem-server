...
lib.onCache('ped', function(value)
    if value then
        ...
        SetPedConfigFlag(value, 380, true)
        SetPedHelmet(value, false)
    end
end)

-- Postal Color
CreateThread(function()
    ReplaceHudColourWithRgba(142, 166, 113, 254, 255)
end)
