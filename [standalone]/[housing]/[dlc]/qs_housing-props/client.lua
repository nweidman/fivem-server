if GetResourceState('qs-housing') == 'started' then
    CreateThread(function()
        ...
        -- Light1
        local light1 = {
            ['img'] = 'img/qs_ceil_lamp_a1.png',
            ['object'] = 'qs_ceil_lamp_a1',
            ['price'] = 1,
            ['label'] = 'Lampara 02',
        ...
        exports['qs-housing']:AddFurniture('light', light1)

        -- Light2
        local light2 = {
            ['img'] = 'img/qs_ceil_lamp_a2.png',
            ['object'] = 'qs_ceil_lamp_a2',
            ['price'] = 2,
            ['label'] = 'Lampara plan4a',
            ['description'] = 'The most modern gaming shelves on the market, thanks to Killstore for their incredible furniture and dolls!',
            ['colorlabel'] = 'White',
            ['colors'] = {},
        }
        exports['qs-housing']:AddFurniture('light', light2)

        -- Light3
        local light3 = {
            ['img'] = 'img/qs_ceil_lamp_a3.png',
            ['object'] = 'qs_ceil_lamp_a3',
            ['price'] = 2,
            ['label'] = 'Lampara colgante pe4queña',
            ['description'] = 'The most modern gaming shelves on the market, thanks to Killstore for their incredible furniture and dolls!',
            ['colorlabel'] = 'White',
            ['colors'] = {},
        }
        exports['qs-housing']:AddFurniture('light', light3)

        -- Light4
        local light4 = {
            ['img'] = 'img/qs_ceil_lamp_a4.png',
            ['object'] = 'qs_ceil_lamp_a4',
            ['price'] = 2,
            ['label'] = 'Lampara bola blanc4a',
            ['description'] = 'The most modern gaming shelves on the market, thanks to Killstore for their incredible furniture and dolls!',
            ['colorlabel'] = 'White',
            ['colors'] = {},
        }
        exports['qs-housing']:AddFurniture('light', light4)

        -- Light5
        local light5 = {
            ['img'] = 'img/qs_ceil_lamp_a5.png',
            ['object'] = 'qs_ceil_lamp_a5',
            ['price'] = 2,
            ['label'] = 'Lampara diseño 11',
            ['description'] = 'The most modern gaming shelves on the market, thanks to Killstore for their incredible furniture and dolls!',
            ['colorlabel'] = 'Brown',
            ['colors'] = {},
        }
        exports['qs-housing']:AddFurniture('light', light5)

        print("[DEBUG]: Import of qs_housing-props completed")
        
        -- Light6
        local light6 = {
            ['img'] = 'img/qs_ceil_lamp_a6.png',
            ['object'] = 'qs_ceil_lamp_a6',
            ['price'] = 2,
            ['label'] = 'Lampara diseño 10',
            ['description'] = 'The most modern gaming shelves on the market, thanks to Killstore for their incredible furniture and dolls!',
            ['colorlabel'] = 'Brown',
            ['colors'] = {},
        }
        exports['qs-housing']:AddFurniture('light', light6)
