      ...
      <div className="rounded-lg bg-1E212C min-h-[132px] max-h-[132px] overflow-hidden">
        <div className="relative flex h-full">
          <div className="relative">
            ...
            <img className="-translate-x-4 min-w-[180px] max-w-[180px]" src="images/core/building-full.png" alt="header-image-building" />
          </div>
          <div className="my-auto text-xl font-bold">
            <h1 className="text-white uppercase font-DMSans font-bold -mb-2">{t("apart_room")}</h1>
            <h1 className="uppercase font-DMSans font-bold text-4xl">{t("security")}</h1>
          </div>
          <div className="my-auto ml-auto mr-6">
            <div className="flex items-center gap-2">
              <div className="flex flex-col items-end">
                <h1 className="font-DMSans font-bold">
                  {inRoom.apartment_label} <span className="text-white">#{inRoom?.room_id}</span>
                </h1>
              </div>
              <div className="ml-2">
                <img className="w-6" src="images/icons/location-2.svg" alt="location-2" />
              </div>
            </div>
          </div>
        </div>
