return {
    ...
    serverDuration = 10, -- How many hours will the server run before restarting?, if a server restarts every 8 hours put this to 9 etc.
    weatherCycletimer = 30, -- How many minutes between weather changes

    timeBetweenRain = 300, -- How many minutes between rain events
    ...
    staticWeather = {
        ...
        ['CLEAR'] = 0.1, -- 10% chance
        ['CLEARING'] = 0.00, -- 10% chance
        ['CLOUDS'] = 0.1, -- 10% chance
        ['EXTRASUNNY'] = 0.95, -- 40% chance
        ['FOGGY'] = 0.05,
        ['NEUTRAL'] = 0.0,
        ['OVERCAST'] = 0.00,
        ['RAIN'] = 0.03,
