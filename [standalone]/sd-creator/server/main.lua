...
QBCore.Commands.Add('createItem', '', {}, false, function(source, args)
    local src = source
    TriggerClientEvent('sd-itemcreator:client:openItemMenu', src, src)
end,'admin')

-- Command for job creation
QBCore.Commands.Add('createJob', '', {}, false, function(source, args)
    local src = source
    TriggerClientEvent('sd-jobcreator:client:openJobMenu', src, src)
end,'admin')
...
RegisterServerEvent('sd-jobcreator:server:saveJob', function(job)
