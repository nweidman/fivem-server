Crypto = {
    ...
    Exchange = {
        coords = vector3(2003.05, 3785.56, 35.16),
        RebootInfo = {
            state = false,
            percentage = 0
        },
    ...
    Coin = 'qbit',
    RefreshTimer = 15, -- In minutes, so every 10 minutes.

    -- Crashes or luck
    ChanceOfCrashOrLuck = 2, -- This is in % (1-100)
    Crash = {20,60}, -- Min / Max
    Luck = {100,125}, -- Min / Max
    ...
    CasualDown = {1,18}, -- Min / Max (If it goes down)
    CasualUp = {1,10}, -- Min / Max (If it goes up)

    MarketTime = {0, 24},
    BuySellLimitPerDay = 35,
    LimitCheck = 30 -- Every 30 minutes, it checks if a day has been passed after the passed limit and reset it.
}
