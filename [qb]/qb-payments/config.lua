...
Config = {
	...
	General = {
		...
		PaymentRadius = 10, 	-- This is how far the playerlist will check for nearby players (based on the person charging)

		Usebzzz = false, 		-- enable if you're using the prop from bzzz

		Enablecommand = false, 	-- Enables the /cashregister command
	...
	Receipts = {
		...
		CashInAnywhere = false,	-- enable this to add cash ticket option to any banking location
		...
		['moo'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.50, },
		...
		['lilypad'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.70, },
		-- ['vanilla'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.70, },
		-- ['upnatom'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.50, },
		['pitapan'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.70, },
		['boathouse'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.50, },
		['bahama'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.50, },
		['saltlabsmoothies'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.50, },
		...
		['smoking'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.50, },
		['highnote'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.50, },

		-- Jim Mechanic | https://jimathy666.tebex.io/
		['stance'] = { MinAmountforTicket = 1000, PayPerTicket = 500, Commission = 0.50, },
		['ss'] = { MinAmountforTicket = 1000, PayPerTicket = 500, Commission = 0.50, },
		--['harmony'] = { MinAmountforTicket = 1000, PayPerTicket = 500, Commission = 0.50, },
		['lscustoms'] = { MinAmountforTicket = 1000, PayPerTicket = 500, Commission = 0.50, },
		['ccm'] = { MinAmountforTicket = 1000, PayPerTicket = 500, Commission = 0.50, },
		['esm'] = { MinAmountforTicket = 1000, PayPerTicket = 500, Commission = 0.55, },

		['photo'] = { MinAmountforTicket = 1000, PayPerTicket = 500, Commission = 0.75, },
		['towing'] = { MinAmountforTicket = 1000, PayPerTicket = 500, Commission = 0.80, },
