...
Config.DefaultColor = '#a671fe' -- Default color for progress bars, circles, menus, etc if not defined when used.
...
Config.Notifications = {
    defaults = {                                    -- Default notification settings
        position = 'top-left',                     -- position options: 'center', 'top-right', 'top-left', 'right', 'left', 'bottom-right', and 'bottom-left'
