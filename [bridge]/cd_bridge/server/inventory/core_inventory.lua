...
function GetSlotFromFirstItemFound(source, item_name)
    local slot = exports.core_inventory:getFirstSlotByItem(source, item_name)
...
function AddQualityToItem(source, item_name, slot, qualityIncrease)
    ...
    exports.core_inventory:setDurability(item_name, slot, newQuality)
end
...
function RemoveQualityToItem(source, item_name, slot, qualityDecrease)
    ...
    exports.core_inventory:removeDurability(item_name, slot, qualityDecrease)
end
...
function SetItemQuality(source, item_name, slot, quality)
    ...
    exports.core_inventory:setDurability(item_name, slot, quality)
end
