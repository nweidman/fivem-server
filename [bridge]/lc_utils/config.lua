...
Config.custom_scripts_compatibility = {
	['fuel'] = "ps-fuel",						-- [lc_fuel|ox_fuel|ti_fuel|ps-fuel|sna-fuel|cdn-fuel|LegacyFuel|okokGasStation|default|other] Fuel script Compatibility
	...
	['keys'] = "Renewed",						-- [qs-vehiclekeys|cd_garage|jaksam|wasabi_carlock|MrNewbVehicleKeys|tgiann-hotwire|Renewed|default|other] Keys script Compatibility
	['mdt'] = "other",						-- [ps-mdt|redutzu-mdt|lb-tablet|default|other] MDT script Compatibility (to log weapon serial)
...
Config.notification = {							-- (Only if notification is default)
	...
	['position'] = "top-left",					-- [top-left|top-center|top-right|middle-left|middle-right|bottom-left|bottom-center|bottom-right] Position of the notification on the screen
...
Config.spawned_vehicles = {						-- Config for the vehicles that are spawned in each script
	['lc_truck_logistics'] = {					-- The script affected by the config (dont change)
		...
		['plate_prefix'] = ""					-- Customize the prefix for the plate text here (a vehicle plate can hold a max of 8 characters)
	},
	['lc_stores'] = {
		['is_static'] = false,
		['plate_prefix'] = ""
