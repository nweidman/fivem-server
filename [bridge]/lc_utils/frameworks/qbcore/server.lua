...
function Utils.Framework.giveAccountMoney(source,amount,account)
	local xPlayer = QBCore.Functions.GetPlayer(source)
	xPlayer.Functions.AddMoney(account, amount, 'Player store, fishing, or trucking')
end
...
function Utils.Framework.tryRemoveAccountMoney(source,amount,account)
	...
	if money >= amount then
		xPlayer.Functions.RemoveMoney(account, amount, 'Player store, fishing, or trucking')
		return true
	else
		return false
	end
