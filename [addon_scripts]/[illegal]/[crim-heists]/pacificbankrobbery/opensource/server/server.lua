...
if Config.Framework == "qb-core" or Config.Framework == "qbox" then
    ...
    function AddMoney(source, cash, amount)
        if Config.Inventory == "ox" then
            ...
            QBCore.Functions.GetPlayer(source).Functions.AddMoney(cash, amount, 'pacific bank')
        end
    end
    ...
    lib.callback.register("projectx-pacificbankrobbery-k4mb1:getOnlinePoliceCountQB", function(source)
    ...
    function DiscordLogItem(source, item, amount, gainedfrom, info)
        ...
        if Config.DiscordLogStatus then
            ...
            if discord ~= 'N/A' then discord = discord:gsub("discord:", "") end
            if not info then
                DiscordLog("Pacific Bank Robbery - Item Gained.","**- PLAYER**\n> **Name: **"..player.PlayerData.name.."\n> **Character Name: **" ..player.PlayerData.charinfo.firstname.. " " ..player.PlayerData.charinfo.lastname.. "\n> **Citizen ID: **" ..player.PlayerData.citizenid.. "\n> **License** " ..player.PlayerData.license.. "\n> **Item Gained: **x" ..amount.. " " ..item.. "\n> **From: **" ..gainedfrom.. "\n> **Location: **" ..location.. "\n\n- **Discord:**\n> (<@" ..discord.. ">)")
            else
...
elseif Config.Framework == "esx" then
    ...
    lib.callback.register('projectx-pacificbankrobbery-k4mb1:server:hasitem', function(source, item)
        if Config.Inventory == "ox" then
    ...
    lib.callback.register("projectx-pacificbankrobbery-k4mb1:getOnlinePoliceCount", function(source)
        if Config.ESX == "old" then 
            ...
            local isEnoughPolice = (policeOnline >= Config.MinimumPolice)
            return isEnoughPolice
        end
    end)

    RegisterServerEvent('projectx-pacificbankrobbery-k4mb1:server:PdNotify', function()
        ...
        for i = 1, #Players do
            ...
            if xPlayer["job"]["name"] == "police" then
                if Config.Notification == "ox" then
                    TriggerClientEvent('ox_lib:notify', xPlayer.source, {description = 'Pacific bank is being robbed!', type = 'error', duration = 10000, position = 'center-right'})
                else
                    TriggerClientEvent('esx:showNotification', xPlayer.source, 'Pacific bank is being robbed!')
                end
            end
        end
        local coords = xPlayer.getCoords(true)
        TriggerClientEvent('projectx-pacificbankrobbery-k4mb1:client:PdNotify', coords)
    end)
    ...
    function DiscordLogCash(source, amount, gainedfrom)
        if Config.DiscordLogStatus then
            ...
            DiscordLog("Pacific Bank Robbery - Money Gained.","**- Info:\n> Name: " ..xPlayer.getName().. "\n> ID: " ..source.. "\n> Money Gained: $" ..amount.. "\n> Gained From: " ..gainedfrom.. "\n>".."\n\n- Identifiers: \n> Discord: " ..discord.. " (<@" ..discord.. ">)\n> License: " ..license.."**")
        end
    end
    ...
    function DiscordLogItem(source, item, amount, gainedfrom, info)
        if Config.DiscordLogStatus then
            ...
            if discord ~= 'N/A' then discord = discord:gsub("discord:", "") end
            if not info then
                DiscordLog("Pacific Bank Robbery - Item Gained.","**- Info:\n> Name: " ..xPlayer.getName().. "\n> ID: " ..source.. "\n> Item Gained: x" ..amount.. " " ..item.. "\n> Gained From: " ..gainedfrom.. "\n>".."\n\n- Identifiers: \n> Discord: " ..discord.. " (<@" ..discord.. ">)\n> License: " ..license.. "**")
            else
                DiscordLog("Pacific Bank Robbery - Item Gained.","**- Info:\n> Name: " ..xPlayer.getName().. "\n> ID: " ..source.. "\n> Item Gained: x" ..amount.. " " ..item.. " ($" ..info.. ")\n> Gained From: " ..gainedfrom.. "\n>".."\n\n- Identifiers: \n> Discord: " ..discord.. " (<@" ..discord.. ">)\n> License: " ..license.. "**")
            end
        end
...
RegisterNetEvent('projectx-pacificbankrobbery-k4mb1:server:AddExperience', function(exp)
    if Config.ServerSideEvents then
        exports["pickle_xp"]:AddPlayerXP(source, "criminal", exp)
    else
        TriggerClientEvent("projectx-pacificbankrobbery-k4mb1:client:AddExperience", source, exp)
    end
end)
...
RegisterCommand('projectxpacific', function(source)
