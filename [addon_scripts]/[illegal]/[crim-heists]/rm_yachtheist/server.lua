            ...
            if type == 'money' then
                ...
                if dist > 100.0 then
                    ...
                    if Config['YachtHeist']['black_money'] then
                        ...
                        player.Functions.AddMoney('cash', count, 'yacht heist')
                        discordLog(player.PlayerData.name ..  ' - ' .. player.PlayerData.license, ' Gain ' .. count .. '$ on Yacht Heist!')
                    end
                end
            else
            ...
            for k, v in pairs(Config['YachtHeist']['rewardItems']) do
                ...
                if playerItem ~= nil and playerItem.amount > 0 then
                    ...
                    if Config['YachtHeist']['black_money'] then
                        ...
                        player.Functions.AddMoney('cash', playerItem.amount * v['sellPrice'], 'yacht heist')
                    end
...
RegisterServerEvent("yachtheist:server:remoteSync", function()
