...
Config.itemCollection = {
    ...
    simple = {
        ...
        },
        {
            ...
            locations = {
                {
                    coords = vector3(203.68, -1846.42, 26.88),
                    rotation = vector3(0, 0, 32),
                    blip = true,
                },
                {
                    coords = vector3(207.29, -1840.85, 27.43),
                    rotation = vector3(0, 0, 35),
                    blip = true,
                },
            },
        },
        {
            ...
            locations = {
                {
                    coords = vector3(206.53, -1841.67, 27.45),
                    rotation = vector3(0, 0, 250),
                    blip = true,
                },
                {
                    coords = vector3(206.27, -1842.19, 27.45),
                    rotation = vector3(0, 0, 150),
                    blip = true,
                },
            },
        },
        {
            ...
            locations = {
                {
                    coords = vector3(205.66, -1845.12, 27.48),
                    rotation = vector3(0, 0, 250),
                    blip = true,
                },
            },
...
Config.guards = {
    ...
    peds = {
        {
            coords = vector3(205.57, -1844.33, 27.75),
            heading = 8.0,
            ...
            zone = {
                coords = vector3(205.11, -1842.8, 27.7),
                radius = 3.5,
            },
        ...
        {
            coords = vector3(208.44, -1837.98, 27.67),
            heading = 316.0,
