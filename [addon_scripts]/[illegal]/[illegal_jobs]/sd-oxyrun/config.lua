...
Config.Cooldown = {
    ...
    Timeout = 5, -- Minutes (How long it takes for the entire run to Timeout.)
    ...
    GlobalCooldown = 0, -- Minutes

    EnablePersonalCooldown = false, -- Cooldown before someone can start another run.
    PersonalCooldown = 10 -- Minutes
}

Config.ViewLevel = false -- Allow players to view their current level and XP when interacting with the starting ped. 

-- Police Alert for Oxy Run (Drug Deal/Suspicious Handoff
...
Config.Ped = {
    Location = {
        {x = -1321.4, y = -253.75, z = 41.12, w = 301.70},
        -- {x = 174.23, y = 2219.57, z = 89.73, w = 102.0},
        -- {x = 448.6, y = -2761.16, z = 6.1, w = 128.04}
    },
...
Config.Supplier = {
    ...
    Locations = { -- The locations where the supplier can spawn.
        ...
        vector4(1623.25, 3535.64, 35.65, 39.03),
        vector4(-608.03, 3020.91, 19.34, 91.72),
        vector4(1517.98, 3653.79, 35.14, 27.05),
...
-- Amount of whatever 'dirty_money' item you have that can be processed at a time (e.g. on delivery of the package and if the chance is right)
Config.Amount = { Type = 'one', max = 20}  -- 'random' for a random amount up to the amount a player has or the max, if the players amount exceeds that of the maximum, 'one' for a fixed amount of 1 (if one, ignore max)
...
Config.Levels = {
    ...
    [1] = {
        ...
        ItemReward = { Item = "oxy", Min = 2, Max = 5 }, -- Rewards for Level 1
        ...
        RareItem = { Enable = true, Chance = 5, Reward = { Items = { "advancedlockpick", "usb_green" }, Min = 1, Max = 1 } }, -- Rare Item Reward for Level 1
        Robbery = { Enable = false, Delay = 1000, Difficulty = {'easy', 'medium', 'medium', 'hard'}, Chance = 25, Inputs = {'w', 'a', 's', 'd'} } -- Settings for the robbery minigame, Level 3 (enable, difficulty, chance of it occuring, etc)
    },
    [2] = {
        ...
        ItemReward = { Item = "oxy", Min = 3, Max = 6 }, -- Adjusted Rewards for Level 2
        ...
        RareItem = { Enable = true, Chance = 8, Reward = { Items = { "advancedlockpick", "usb_green" }, Min = 1, Max = 1 } }, -- Rare Item Reward for Level 2
        Robbery = { Enable = false, Delay = 1000, Difficulty = {'easy', 'medium', 'medium'}, Chance = 18, Inputs = {'w', 'a', 's', 'd'} }, -- Settings for the robbery minigame, Level 2 (enable, difficulty, chance of it occuring, etc)
    },
    [3] = {
        ...
        ItemReward = { Item = "oxy", Min = 4, Max = 7 }, -- Adjusted Rewards for Level 3
        ...
        RareItem = { Enable = true, Chance = 10, Reward = { Items = { "security_card_oil", "usb_green" }, Min = 1, Max = 1 } }, -- Rare Item Reward for Level 3
        Robbery = { Enable = false, Delay = 1500, Difficulty = {'easy', 'easy', 'easy'}, Chance = 7, Inputs = {'w', 'a', 's', 'd'} }, -- Settings for the robbery minigame, Level 3 (enable, difficulty, chance of it occuring, etc)
    }
}
