clConfig = {
    ...
    tunedVehiclePerformanceModIndices = {},

    -- If the turbo be toggled on a tuned boosting vehicle.
    tunedVehicleToggleTurbo = false,
    ...
    gpsNotificationSoundName = '',
    gpsNotificationSoundRef = '',
    ...
    orderLocation = vector3(-591.91, -1765.55, 23.18)
}