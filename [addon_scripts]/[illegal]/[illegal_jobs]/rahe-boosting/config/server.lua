svConfig = {
    ...
    vehicleClasses = {
        [1] = {
            class = "OS",
            xpRequired = 5000,
            generationPercentage = 5,--Changed from 1 to 20.
            timeBetweenGenerations = 60, --Changed from 120 to 60.
            isImportant = true,
            gpsHacksRequired = 10, --Changed from 20 to 10.
            gpsHackMinTime = 12,--Changed from 20 to 15
            gpsHackMaxTime = 30,--Changed from 25 to 20
            maxContractsOfType = 1,
            maxContractsPerSession = 1,
            priceMin = 750,--Changed from 500 to 300
            priceMax = 1250,--Changed from 900 to 500
            minScratchPrice = 2750, --Changed from 7000 to 1300. If we raise this there will be certain cars that will never make sense to vin, but if we do not raise it there is a chance you could vin a 200k+ car for 130k worth of sCoin. So mayeb we move the cheaper S classes to A and add more expensive ones to S
            maxScratchPrice = 3000, --Changed from 11000 to 2500. depending on which cars are added to S this may need to increase. 
            rewardCashMin = 50000, 
            rewardCashMax = 75000,
            rewardCryptoMin = 900,--Changed from 1000 to 550.
            rewardCryptoMax = 1100,--Changed from 1400 to 800
            experiencePerJob = 27,--Changed from 12 to 25.
            bonusExperienceMultiplier = 4,
            bonusExperienceMinimumMembers = 4,
            tuningChance = 35,--Changed from 25 to 35
            riskChances = {
                doorsLocked = 100,
        ...
        [2] = {
            class = "S",
            xpRequired = 2500,
            generationPercentage = 20,--Changed from 1 to 20.
            timeBetweenGenerations = 60, --Changed from 120 to 60.
            isImportant = true,
            gpsHacksRequired = 8, --Changed from 20 to 10.
            gpsHackMinTime = 15,--Changed from 20 to 15
            gpsHackMaxTime = 35,--Changed from 25 to 20
            maxContractsOfType = 1,
            maxContractsPerSession = 3,
            priceMin = 300,--Changed from 500 to 300
            priceMax = 500,--Changed from 900 to 500
            minScratchPrice = 1300, --Changed from 7000 to 1300. If we raise this there will be certain cars that will never make sense to vin, but if we do not raise it there is a chance you could vin a 200k+ car for 130k worth of sCoin. So mayeb we move the cheaper S classes to A and add more expensive ones to S
            maxScratchPrice = 1800, --Changed from 11000 to 2500. depending on which cars are added to S this may need to increase. 
            rewardCashMin = 35000, 
            rewardCashMax = 50000,
            rewardCryptoMin = 700,--Changed from 1000 to 550.
            rewardCryptoMax = 900,--Changed from 1400 to 800
            experiencePerJob = 23,--Changed from 12 to 25.
            bonusExperienceMultiplier = 4,
            bonusExperienceMinimumMembers = 4,
            tuningChance = 35,--Changed from 25 to 35
            riskChances = {
        ...
        [3] = {
            ...
            isImportant = true,
            gpsHacksRequired = 6, --Changed from 10 to 6
            gpsHackMinTime = 20,
            gpsHackMaxTime = 40,
            maxContractsOfType = 3,
            maxContractsPerSession = 6,
            priceMin = 100,
            priceMax = 200,--Changed from 450 to 350
            minScratchPrice = 600,--Changed from 2500 to 700
            maxScratchPrice = 1000,--Changed from 4500 to 1299
            rewardCashMin = 18000,
            rewardCashMax = 30000,
            rewardCryptoMin = 350,--Changed from 500 250
            rewardCryptoMax = 500,-- Changed from 700 to 400
            experiencePerJob = 12,--Changed from 8 to 12. 32 A boosts required to get to A compared to 46 before
            bonusExperienceMultiplier = 4,
            bonusExperienceMinimumMembers = 3, --Changed from 4 to 3
            tuningChance = 35,--Changed from 25 to 35
            riskChances = {
                doorsLocked = 100,
                advancedLockChance = 0,
        ...
        [4] = {
            ...
            isImportant = false, -- Changed to true
            maxContractsOfType = 3,--Changed from 1 to 3
            maxContractsPerSession = 0,
            priceMin = 30,--Changed from 40 to 30
            priceMax = 50,--Changed from 60 to 50
            minScratchPrice = 300,--Changed from 600 to 400
            maxScratchPrice = 500,--Changed from 800 to 699
            rewardCashMin = 6000, --Remained at 5000
            rewardCashMax = 12000, --Increased from 8000 to 10000
            rewardCryptoMin = 60,
            rewardCryptoMax = 90,
            experiencePerJob = 10, --Changed from 3 to 10. With a full group it now requires 30 B boosts instead of 75 to get to A.
            bonusExperienceMultiplier = 3,
            bonusExperienceMinimumMembers = 2,--Changed from 3 to 2
            tuningChance = 15,--Changed from 25 to 35
            riskChances = {
                doorsLocked = 100,
                advancedLockChance = 100, --Changed from 50 to 100. Advanced lockpick is now required to unlock cars.
                advancedSystemChance = 0,
                npcChance = 50 --Changed from 0 to 50. Npc's have a 50% chance of spawning.
            }
        },
        [5] = {
            class = "C",
            xpRequired = 10,--Changed from 6 to 10. 10 D boosts required to get to C solo, 5 with group.
            generationPercentage = 45,
            timeBetweenGenerations = 0,
            isImportant = false,
            maxContractsOfType = 3, --Increased to 5 from 2. 
            maxContractsPerSession = 0,
            priceMin = 3,
            priceMax = 6,
            minScratchPrice = 100,--Changed from 90 to 150
            maxScratchPrice = 300,--Changed from 180 to 399
            rewardCashMin = 2500,
            rewardCashMax = 6000,
            rewardCryptoMin = 6,
            rewardCryptoMax = 12,--Changed from 9 to 12
            experiencePerJob = 3,--Changed from 2 to 3. Now takes 30 solo C class boosts to get to B compared to 45 before. 
            bonusExperienceMultiplier = 2,--Changed from 3 to 2
        ...
        [6] = {
            ...
            priceMin = 0,
            priceMax = 0,
            minScratchPrice = 45,-- Changed from 60 to 45
            maxScratchPrice = 65, -- Changed from 120 to 65
            rewardCashMin = 1500,
            rewardCashMax = 2500,
            rewardCryptoMin = 1,
            rewardCryptoMax = 2,-- Changed from 1 to 2
            experiencePerJob = 1,
            bonusExperienceMultiplier = 2,
            bonusExperienceMinimumMembers = 2,
            tuningChance = 10,
            riskChances = {
                doorsLocked = 50, --Changed from 0 to 25
                advancedLockChance = 0,
                advancedSystemChance = 0,
                npcChance = 0
            }
    ...
    storeItems = {
       ...
       --
        ['cryptostick'] = {
            cashRequired = 5000,--Changed from 2500 to 5000
            cryptoRequired = 50,--Changed from 300 to 50
            availablePerRestart = 5,
            isSoldOut = false,
            title = "Crypto Sticks",
            description = "10 Crypto Sticks",
            iconFile = 'cryptostick.png',
            receiveItemIds = {
                [1] = 'cryptostick',
                [2] = 'cryptostick',
                [3] = 'cryptostick',
		...
		['pistolparts'] = { --Needs correct item/image name
            cashRequired = 20000,
            cryptoRequired = 300,
            availablePerRestart = 3, --Changed from 5 to 3
            isSoldOut = false,
            title = "Pistol Parts Shipment",
            description = "10 Pistol Parts",
            iconFile = 'pistolparts.png',
            receiveItemIds = {
                [1] = 'pistolparts',
                [2] = 'pistolparts',
                [3] = 'pistolparts',
        ...
        ['suppressor'] = {
            ...
            isSoldOut = false,
            title = "Suppressor",
            description = "Suppresses the sound of gunshots",
            iconFile = 'suppressor.png',
            receiveItemIds = {
                [1] = 'suppressor'
            }
        },
        ['attachment_flashlight'] = {
            ...
            description = "Attachment for weapons to provide light in dark places.",
            iconFile = 'attachment_flashlight.png',
            receiveItemIds = {
                [1] = 'attachment_flashlight'
            }
        },    
		['dynamite'] = {--Needs correct item/image name
			cashRequired = 20000,
			cryptoRequired = 200,
			availablePerRestart = 2,
			isSoldOut = false,
			title = "Dynamite",
			description = "High-grade Dynamite for advanced heists.",
			iconFile = 'dynamite.png',
			receiveItemIds = {
				[1] = 'dynamite'
			}
		},

		['explosive'] = {--Needs correct item/image name
			cashRequired = 5000,
			cryptoRequired = 75,
			availablePerRestart = 10,
			isSoldOut = false,
			title = "Explosive",
			description = "Standard explosive for breaking through obstacles.",
			iconFile = 'explosive.png',
			receiveItemIds = {
				[1] = 'explosive'
			}
		},

		['heistmysterybox'] = {--Needs correct item/image name
			cashRequired = 10000,
			cryptoRequired = 100,
			availablePerRestart = 2,
			isSoldOut = false,
			title = "Heist Mystery Box",
			description = "Test your luck with a heist mystery box.",
			iconFile = 'mysterybox.png',
			receiveItemIds = {
				[1] = 'heistmysterybox'
			}
		},
		...
		['advancedlockpick'] = {--Needs correct item/image name
			cashRequired = 3000,
			cryptoRequired = 20,
			availablePerRestart = 10,
			isSoldOut = false,
			title = "Advanced Lockpick",
			description = "An advanced tool for picking more secure locks.",
		...
		['gpshackingdevice'] = {--Needs correct item/image name
			cashRequired = 10000,
			cryptoRequired = 15,
			availablePerRestart = 2,
			isSoldOut = false,
			title = "GPS Hacking Device",
			description = "A device to manipulate GPS signals.",
		...
		['hackingdevice'] = {--Needs correct item/image name
			cashRequired = 10000,
			cryptoRequired = 15,
			availablePerRestart = 2,
			isSoldOut = false,
			title = "Door Hacking Device",
			description = "A device for hacking into car door security systems.",
		...
		['boostingtablet'] = { --Needs correct item/image name
			cashRequired = 15000,
			cryptoRequired = 30,
			availablePerRestart = 1,
			isSoldOut = false,
			title = "Boosting Tablet",
			description = "A tablet used for vehicle boosting jobs.",
			iconFile = 'boostingtablet.png',
			receiveItemIds = {
				[1] = 'boostingtablet'
			}
		},
		['accesstool'] = { --Needs correct item/image name.
			cashRequired = 10000,
			cryptoRequired = 100,
			availablePerRestart = 3,
			isSoldOut = false,
			title = "Access Tool",
			description = "A more efficient tool for bypassing car security system's.",
			iconFile = 'accesstool.png',
			receiveItemIds = {
				[1] = 'accesstool'
			}
		},

		['armor'] = { --Needs correct item/image name
			cashRequired = 3000,
			cryptoRequired = 20,
			availablePerRestart = 10,
			isSoldOut = false,
			title = "Armor",
			description = "Protective gear to reduce damage.",
			iconFile = 'armor.png',
			receiveItemIds = {
				[1] = 'armor'
			}
		...
		['bag'] = { --Needs correct item/image name
			cashRequired = 15000,
			cryptoRequired = 50,
			availablePerRestart = 1,
			isSoldOut = false,
			title = "Heist Bag",
			description = "A bag to collect loot during heists.",
			iconFile = 'bag.png',
			receiveItemIds = {
				[1] = 'bag'
			}
        ...
        -- ['fakeplate'] = { --Needs correct item/image name
		-- 	cashRequired = 5000,
		-- 	cryptoRequired = 20,
		-- 	availablePerRestart = 10,
		-- 	isSoldOut = false,
		-- 	title = "Fake Plate",
		-- 	description = "A temporarily replacement for a vehicle's license plate.",
		-- 	iconFile = 'fakeplate.png',
		-- 	receiveItemIds = {
		-- 		[1] = 'fakeplate'
		-- 	}
		-- },

		['smg_case'] = { --Needs correct item/image name
			cashRequired = 8000,
			cryptoRequired = 40,
			availablePerRestart = 5,
			isSoldOut = false,
			title = "SMG Ammo Case",
			description = "A pack of 30 SMG ammo.",
			iconFile = 'smg_case.png',
			receiveItemIds = {
				[1] = 'smg_case',
			}
		},

		['rifle_case'] = { --Needs correct item/image name
			cashRequired = 10000,
			cryptoRequired = 50,
			availablePerRestart = 5,
			isSoldOut = false,
			title = "AR Ammo Case",
			description = "A pack of 30 assault rifle ammo.",
			iconFile = 'rifle_case.png',
			receiveItemIds = {
				[1] = 'rifle_case',
			}
		},

		-- ['purebagofmeth'] = {--Needs correct item/image name
		-- 	cashRequired = 15000,
		-- 	cryptoRequired = 225,
		-- 	availablePerRestart = 1,
		-- 	isSoldOut = false,
		-- 	title = "Meth Shipment x50",
		-- 	description = "A shipment of 50 units of meth.",
		-- 	iconFile = 'meth_baggy.png',
		-- 	receiveItemIds = {
		-- 		[1] = 'purebagofmeth',
        --         [2] = 'purebagofmeth',
        --         [3] = 'purebagofmeth',
		...
		-- ['purebagofcoke'] = {--Needs correct item/image name
		-- 	cashRequired = 12500,
		-- 	cryptoRequired = 200,
		-- 	availablePerRestart = 1,
		-- 	isSoldOut = false,
		-- 	title = "Coke Shipment x50",
		-- 	description = "A shipment of 50 units of cocaine.",
		-- 	iconFile = 'coke_bag.png',
		-- 	receiveItemIds = {
		-- 		[1] = 'purebagofcoke',
        --         [2] = 'purebagofcoke',
        --         [3] = 'purebagofcoke',
		...
		-- ['purebagofweed'] = {--Needs correct item/image name
		-- 	cashRequired = 10000,
		-- 	cryptoRequired = 150,
		-- 	availablePerRestart = 1,
		-- 	isSoldOut = false,
		-- 	title = "Weed Shipment x50",
		-- 	description = "A shipment of 50 units of weed.",
		-- 	iconFile = 'weed_bag.png',
		-- 	receiveItemIds = {
		-- 		[1] = 'purebagofweed',
        --         [2] = 'purebagofweed',
        --         [3] = 'purebagofweed',
...
supportedVehicles = {
    ...
    -- OS Class  
    { name = "Bati 901", model = "bati901", class = "OS" }, --Added
	{ name = "Tempesta Type R", model = "tempestafr", class = "OS" }, --Added
    { name = "Hachu", model = "hachurac", class = "OS" }, --Added
	{ name = "Elegy RH7", model = "elegyrh7", class = "OS" }, --Added
	{ name = "Cyclone XE", model = "cycloneex0", class = "OS" }, --Added
	{ name = "Baller XR", model = "baller7r", class = "OS" }, --Added
	{ name = "Vigout R", model = "vigout", class = "OS" }, --Added

    -- S Class
	{ name = "Adder", model = "adder", class = "S" },
	{ name = "811", model = "pfister811", class = "S" },
	{ name = "10F Widebody", model = "tenf2", class = "S" },
	{ name = "10F", model = "tenf", class = "S" },
	{ name = "Krieger", model = "krieger", class = "S" },
	{ name = "T20", model = "t20", class = "S" },
	{ name = "Entity XF", model = "entityxf", class = "S" },
	{ name = "ETR1", model = "sheava", class = "S" },
	{ name = "Vacca", model = "vacca", class = "S" }, --Added
    { name = "Tempesta", model = "tempesta", class = "S" }, --Added
	{ name = "Thrax", model = "thrax", class = "S" }, --Added
	{ name = "Tyrant", model = "tyrant", class = "S" }, --Added
	{ name = "Visione", model = "visione", class = "S" }, --Added
    ...
    { name = "Cheval Taipan", model = "taipan", class = "S" },
    ...
    { name = "Vagner", model = "vagner", class = "A" }, --Added

	
    -- B Class
    { name = "Albany Alpha", model = "alpha", class = "B" },
    { name = "Enus Stafford", model = "stafford", class = "B" },
	...
	{ name = "Beater Dukes", model = "dukes3", class = "B" },
	{ name = "Dinka Kanjo", model = "kanjo", class = "B" },
	{ name = "Vapid Slamvan", model = "slamvan", class = "B" },
    { name = "Vapid Slamvan Custom", model = "slamvan3", class = "B" },
	{ name = "Karin 190z", model = "z190", class = "B" },
    ...
    { name = "Declasse Vamos", model = "vamos", class = "C" },
    ...
    { name = "Declasse Yosemite", model = "yosemite", class = "C" },
    { name = "Declasse Tornado Rat", model = "tornado6", class = "C" },
    ...
    { name = "Declasse Moonbeam Custom", model = "moonbeam2", class = "D" },
