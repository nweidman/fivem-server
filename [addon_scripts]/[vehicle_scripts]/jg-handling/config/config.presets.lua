...
Config.Presets.Acceleration = {
  {
    ...
    values = { fDriveInertia = 1.0, fInitialDriveForce = 0.43, fInitialDragCoeff = 5.0 },
  },
  {
    name = "Sportscar",
    desc = "Quick realistic acceleration, up to the top speed specified.",
    values = { fDriveInertia = 1.0, fInitialDriveForce = 0.37, fInitialDragCoeff = 5.0 },
  },
  {
    name = "Normal",
    desc = "Acceleration profile for an average vehicle in GTA, up to the top speed specified.",
    values = { fDriveInertia = 1.0, fInitialDriveForce = 0.33, fInitialDragCoeff = 5.0 },
  },
  {
    name = "Drift",
