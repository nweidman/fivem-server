Config = {}
Config.JerryCanFuelPerDurability = 0.30     -- Example: 0.5 means 100 durability can only give 50L fuel total.
Config.JerryCanMaxFuelPerUse = false        -- Example: even if the can has more, one fueling session can only add 25L fuel.
...
Config.LeaveEngineRunning = false -- when set to true vehicle engine will run upon exiting vehicle
...
Config.RefillCost = 250 -- default price
Config.CostMultiplier = 3.0 -- tax basically
Config.canCost = 650 -- buy jerry can price
...
Config.GasStationsBlips = { -- gas station blips
    ...
    vector3(1039.0983, 2671.3396, 40.4683),
