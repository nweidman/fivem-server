      ...
      for _, location in ipairs(locations) do
        if not location.employeeOnly or isMechanicEmployee then
          ...
          if blip and location.showBlip then
            ...
            local mechLabel = nil
            if Config.MechanicLocations[name] and Config.MechanicLocations[name].job then
                mechLabel = exports.qbx_core:GetJob(Config.MechanicLocations[name].job)
            end
            if mechLabel then mechName = mechLabel.label end
