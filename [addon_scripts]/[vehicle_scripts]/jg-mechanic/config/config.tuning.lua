...
Config.Tuning = {
  ...
  engineSwaps = {
    [1] = {
      name = "I4 Turbo 2.5L",
      icon = "engine.svg",
      info = "A twin-turbo charged 2.5L engine!",
      itemName = "i4_engine",
      price = 30000,
      audioNameHash = "bnr34ffeng",
    ...
    [2] = {
      name = "V6 3.3L",
      icon = "engine.svg",
      audioNameHash = "n55b30t0",
      info = "Tuned V6 engine!",
      itemName = "v6_engine",
      price = 40000,
      handlingOverwritesValues = false,
      handlingApplyOrder = 1,
  ...
  drivetrains = {
    [1] = {
      ...
      blacklist = {"rrsentinelx", "pace_sunrise", "killerhwak", "rrsultanx", "rrelegyextreme", "KillerWagenR", "KillerM4", "evoix", "GODzTRACKCAT", "rrseminoleex", "rrgauntcustom", "polycypherwagon", "GODzDRB26SUBI", "DBTaycans20", "labskuruma", "204s24Buffalo", "204sSentinelComp"}
    },
    [2] = {
      name = "RWD",
      icon = "drivetrain.svg",
  ...
  driftTuning = {
    [1] = {
      ...
      handling = {
        ...
        fInitialDriveMaxFlatVel = 152.0,
        fSteeringLock = 58.0,
        fTractionCurveMax = 0.7,
