...
Config.Mods.Performance = {
  { modType = 11, name = "Engine", overrideOptions = {
    { modIndex = 0, name = "Engine Upgrade, Level 1" },
    { modIndex = 1, name = "Engine Upgrade, Level 2" },
    { modIndex = 2, name = "Engine Upgrade, Level 3" },
    { modIndex = 3, name = "Engine Upgrade, Level 4" }
  } },
  ...
  { modType = 18, name = "Turbocharging", toggle = false } 
}
