...
Locales["en"] = {
  ...
  tyres = "Tires",
  tyreSmoke = "Tire Smoke",
  customTyreSmoke = "Custom Tire Smoke",
  ...
  tyre_replacement = "Tire Replacement",
  ...
  slick_tyres = "Slick Tires",
  semi_slick_tyres = "Semi Slick Tires",
  offroad_tyres = "Offroad Tires",
  ...
  tyre_smoke_kit = "Tire Smoke Kit",
  bulletproof_tyres = "Bulletproof Tires",
