...
Config.Price = 58            -- Means $5 per one window, so the full reward depends on current location
...
Config.Clothes = {
    male = {
        ...
        ["pants"] = {clotheId = 90, variation = 5},
        ["bag"] = {clotheId = 0, variation = 0},
        ["shoes"] = {clotheId = 152, variation = 1},
        ["t-shirt"] = {clotheId = 15, variation = 0},
        ["torso"] = {clotheId = 0, variation = 2},
    ...
    female = {
        ...
        ["pants"] = {clotheId = 93, variation = 4},
        ["bag"] = {clotheId = 0, variation = 0},
        ["shoes"] = {clotheId = 213, variation = 1},
        ["t-shirt"] = {clotheId = 14, variation = 0},
...
Config.Lang = {
    ...
    ["keybind"] = 'Window Cleaner Marker Interaction',
    ...
    ["enterPlatform"] = "Enter platform and start job",
    ["exitPlatform"] = "Exit Platform",
    ["cleanWindowInfo"] = "Press ~INPUT_CONTEXT~ to ~y~start~s~ cleaning window",
    ["spawnpointOccupied"] = "The car's spawn site is occupied",
    ["notADriver"] = "You need to be a driver of vehicle to end the job",
    ["someoneIsAlreadyCleaning"] = "Someone is already cleaning this window",
    ...
    ["tutorial1"] = "The job is to clean the windows of apartment buildings, the location of your current job has been designated. Go to the site, and start work there. Once you get on the roof, start cleaning the windows. You can finish working whenever you want, your pay depends on how many windows you clean. When you want to finish working, return to the base and return the company car. When you finish cleaning all the windows, you need to go to the base to get your paycheck",
    ["tutorial2"] = "You are on the platform! Your task is to clean the windows below you. The team owner can move the platform with the arrows on the keyboard. At the very top there is a text with which you can get off the platform. This is also an emergency exit in case one of the team members falls down. Using this button by one person will transport the whole team down. To count the window as washed, you have to wipe at least 95% of the surface",
    ["partyIsFull"] = "Failed to send an invite, your group is full",
    ["inviteSent"] = "Invite Sent!",
    ["youCanControl"] = "Something went wrong with your party leader. From now on, you can control the hamper",
    ...
    ["emergencyStop"] = "One member of the team was injured. We transported you down",
    ["tooFar"] = "One of the players walked too far away from the platform. We moved you to the bottom",
