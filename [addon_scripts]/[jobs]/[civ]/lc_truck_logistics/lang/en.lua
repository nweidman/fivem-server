...
Lang['en'] = {
    ...
    ['fast_cargo_timer'] = '~w~You have ~b~%s~w~ seconds to deliver the ~y~cargo~w~.',
    ['failed_urgent_time'] = "You failed to deliver the urgent cargo on time. You'll receive a %s%% penalty to your reward",
    ['failed_fragile_health'] = "You failed to deliver the fragile cargo with more than %s%% health. You'll receive a %s%% penalty to your reward",
    ...
    ['cargo_inspect_interaction'] = "Press ~INPUT_CONTEXT~ to inspect the cargo",
    ['cargo_inspect_interaction_target'] = "Inspect the trailer cargo",
    ['cargo_inspect_message'] = "Inspection report: Cargo identified as '%s'",
    ['cargo_inspect_empty'] = "Empty",
    ['cargo_inspect_illegal_message'] = "Suspicious cargo detected: %s",
    ['cargo_inspect_must_be_police'] = "You must be a cop to do that.",
    ['cargo_inspect_loading'] = "Inspecting...",
    ...
    ['reward'] = "Received: $%s. Load condition: %s%% EXP: %s",
