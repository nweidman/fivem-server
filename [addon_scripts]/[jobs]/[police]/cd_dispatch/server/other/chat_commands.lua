if Config.JobCallCommands.ENABLE then
    ...
    AddEventHandler('cd_dispatch:CallCommand', function(data, data_2)
        ...
        if AntiCheatTriggered(_source, data_2.job_table, {data.street, data_2.job_label, data_2.message, data_2.phone_number, data_2.char_name}) then return end
    ...
    AddEventHandler('cd_dispatch:CallCommand:Reply', function(data)
        ...
        if AntiCheatTriggered(_source, data.job_table, {data.job_label, data.char_name, data.message}) then return end
