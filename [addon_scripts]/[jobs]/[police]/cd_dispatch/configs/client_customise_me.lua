...
RegisterNetEvent('cd_dispatch:refreshBlips')
AddEventHandler('cd_dispatch:refreshBlips', function()
    print("Refreshing blips...")
    -- Clear all blips
    for _, blip in pairs(ExistingBlips or {}) do
        if DoesBlipExist(blip) then
            RemoveBlip(blip)
        end
    end
    -- Recreate blips (this will depend on your cd_dispatch logic)
    TriggerEvent('cd_dispatch:initializeBlips') -- Example: call your blip initialization logic
end)
