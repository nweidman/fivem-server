...
CreateThread(function()
    if Config.Inventories == Inventories.QB then
        ...
        Inventory.DoesItemExist = function(itemName, playerId)
            if ServerItems and itemName and ServerItems[itemName:upper()] then
                return true
            end
        ...
        AssetDeployer:registerCopyFilesDeploy('items-images', Inventories.QB, 'assets/inventoryImages', 'html/images',
            function(data)
                local files = {}
