...
local query = "SELECT name FROM ox_inventory WHERE name LIKE 'Gunrack_%'"

MySQL.query(query, {}, function(result)
     for _, row in ipairs(result) do
          exports.ox_inventory:RegisterStash(row.name, row.name, Config.gunrack.slots, Config.gunrack.size)
     end
end)
