...
Framework = {
  ...
  IdentityStats = {
    ...
    },
    {
      ...
      column = "metadata",
      identifier = "citizenid",
      value = { "fingerprint", "bloodtype" },
      label = { "Fingerprint: {fingerprint}", "Bloodtype: {bloodtype}" },
      enabled = true
    },
    {
  ...
  VehicleStats = {
    ...
    },
    {
      ...
      column = "impound_data",
      identifier = "plate",
      value = {"charname", "reason", "retrieval_date", "retrieval_cost"},
      label = {"Impounding Officer: {charname}", "Impound Reason: {reason}", "Retrieval Date: {retrieval_date}","Retrieval Cost: {retrieval_cost}"},
      enabled = true
    },
    {
      table = "player_vehicles",
      column = "mods",
      identifier = "plate",
      value = {"modEngine", "modTurbo", "modBrakes", "modTransmission", "modArmor", "modSuspension"},
      label = {"Engine: {modEngine}", "Turbo: {modTurbo}", "Brakes: {modBrakes}", "Transmission: {modTransmission}", "Armor: {modArmor}", "Suspension: {modSuspension}"},
      enabled = true
    },
  },
