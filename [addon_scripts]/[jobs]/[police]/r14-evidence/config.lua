...
Config.Context = {
    ...
    QB = false, -- use this for qb-menu/input
...
Config.Locations = {
    ["NoDispatchZones"] = {
        ...
        [4] = {label = "Aircraft Carrier", coords = vector3(3055.07, -4699.5, 15.26), length = 250.0, width = 500.0, heading = 25, minZ = -10.62, maxZ = 60.62},
    },
}
...
Config.EvidenceLimits = {
    Max = 750, -- max number of evidence pieces held on the server
    RemoveAfterLimit = 50, -- number of evidence pieces removed when hitting the max limit
}

Config.EvidenceFadeTime = {
    Casings = 30, -- time, in minutes, that casings remain before being removed
    Impact = 30, -- time, in minutes, that bullet impacts remain in workd before being removed
    Blood = 30, -- time, in minutes, that fingerprints remain before being removed
    Fingerprint = 30, -- time, in minutes, that fingerprint evidence gets removed without player intervention
    Tampering = 15, -- time, in minutes, that lock tamperings get removed
    Fragment = 15, -- time, in minutes, that vehicle fragments remain in world before being removed
    NetImpact = 15, -- time in minutes, that network entity remain in world before getting removed
    NetPedImpact = 15, -- time in minutes, that network ped impacts remain in world before getting removed
    ...
    WeaponPrints = 30, -- time, in days, that fingerprints stay on weapons without player intervention
    WeaponBlood = 15, -- time, in days, that blood stays on a weapon without player intervention
}

Config.VehCasingChance = 40 -- set this to a number between 1 and 100, higher equals greater chance of casings staying in vehicle when fired in drive by

Config.Bleed = {
    EnableCommand = false, -- set to FALSE to disabled the /bleed command that allows players to generate blood evidence (but recieve damage when doing so)
    PreventDeath = false, -- set to FALSE to allow players to down themselves using the bleed command
...
Config.GSR = {
    MinShotsStatus = 10, -- the amount of times someone can fire nearby a player before they get a gunpowder status effect
    MinShotsPositive = 1, -- the amount of times a player needs to shoot to test positive for GSR (not get a gunpowder status effect)
    FadeTime = 30, -- the amount, in minutes, it takes for a player to not test positive for GSR
    WhileAiming = false, -- this sets whether or not aiming a weapon will generate a positive GSR test
    AimingTime = 8, -- the time, in seconds, it takes for a player to test positive for GSR if aiming a weapon
    ShootingChance = 75, -- set to FALSE to use only MinShotsPositive, or set to a number between 1 and 100 to enable a chance of becoming GSR positive (less realistic, more rp leeway)
    NearbyChance = 15, -- set to FALSE to use only MinShotsStatus, or set to a number between 1 and 100 to enable a chance of becoming GSR positive (less realistic, more rp leeway)
    AimingChance = 10, -- set to FALSE to use only AimingTime, or set to a number between 1 and 100 to enable a chance of becoming GSR positive (less realistic, more rp leeway)
...
Config.Consume = {
    ...
    AccessTool = 5, -- set to a number of uses if desired, if not set to false for no usage limit
}
...
Config.Notification = {
    ClutterReminder = 'You notice the car is full of trash and clutter.',
...
['WEAPON_KNIFEEASTER1'] 		 = true,
['WEAPON_KNIFEEASTER2'] 		 = true,
['WEAPON_MACHETEEASTER'] 		 = true,
['weapon_pistol'] 				 = true,
...
['weapon_glock'] 	 = true,
['weapon_dp9'] 		= true,
['weapon_browning'] 	= true,
['weapon_microsmg2'] 	= true,
['weapon_microsmg3'] 	= true,
['weapon_mp7'] 	        = true,
['weapon_minismg2'] 	= true,
['weapon_assaultrifle2'] = true,
['weapon_m4'] 		= true,
...
['weapon_nailgun'] 	= true,
['weapon_ltl'] 	        = true,
["WEAPON_NIGHTSTICK"] = true, -- Night Stick
    ["WEAPON_HAMMER"] = true, -- Hammer
    ["WEAPON_BAT"] = true, -- Bat
    ["WEAPON_CROWBAR"] = true, -- Crowbar
    ["WEAPON_GOLFCLUB"] = true, -- Golfclub
    ["WEAPON_HATCHET"] = true, -- Hatchet
    ["WEAPON_MACHETE"] = true, -- Machete
    ["WEAPON_WRENCH"] = true, -- Wrench
    ["WEAPON_BATTLEAXE"] = true, -- Battle Axe
    ['WEAPON_PISTOL'] = true,
    ['WEAPON_PISTOL_MK2'] = true,
    ['WEAPON_COMBATPISTOL'] = true,
    ['WEAPON_APPISTOL'] = true,
    ...
    ['weapon_gang9'] = true,
    ['weapon_gang10'] = true,
    ['WEAPON_EASTERAP'] = true,
    ['WEAPON_EASTERHB'] = true,
    ['WEAPON_EASTERSEMI'] = true,
    ['WEAPON_M320b'] = true,
    ['weapon_x17'] = true,
    ['weapon_g19xcustom'] = true,
    ['weapon_glock22'] = true,
    ['weapon_g17g5mos'] = true,
    ['weapon_g26switchp'] = true,
    ['weapon_cg17p80s'] = true,
    ['weapon_glock41'] = true,
    ['weapon_g19xblack'] = true,
    [`WEAPON_PROJECTX`] = true, 
    [`WEAPON_PROJECTXSMG`] = true, 
    [`WEAPON_PROJECTXPISTOL`] = true, 
    [`WEAPON_ARCTIC516`] = true,
    [`WEAPON_MB47`] = true,
    [`WEAPON_2S`] = true,
    [`WEAPON_A45`] = true,
    [`WEAPON_590`] = true,
    [`WEAPON_MK18`]= true,
    [`WEAPON_RATREV`] = true,
    [`WEAPON_FMICRODRAGON`] = true,
    [`WEAPON_PSTRIKEH`] = true,
    [`WEAPON_PSPIKE`] = true,
    [`WEAPON_PH4`] = true,
    [`WEAPON_PT39`] = true,
    [`WEAPON_P1911KT`] = true,
...
Config.Functions = {
    ...
    CreateUseableItem = function(name, cbfunc)
        if Config.Inventory.Ox and false then
            exports(name, cbfunc)
        elseif Config.Inventory.QB or true then
...
Config.Calibers = { 
    ...
    [`WEAPON_G17G5MOS`]             = '9x19mm Parabellum',	          
    [`WEAPON_MREVOLVER`] = '9x19mm Parabellum',
    [`WEAPON_PISTOLXM3`] ='9x19mm Parabellum',
    [`WEAPON_RAYPISTOL`] = '9x19mm Parabellum',
    [`WEAPON_CG17P80S`] = '9x19mm Parabellum',	
    [`WEAPON_PROJECTX`] = '7.76x51mm NATO', 
    [`WEAPON_PROJECTXSMG`] = '9x19mm Parabellum', 
    [`WEAPON_PROJECTXPISTOL`] = '9x19mm Parabellum', 
    [`WEAPON_ARCTIC516`] = '7.76x51mm NATO',
    [`WEAPON_GLOCK41`]  = '9x19mm Parabellum',
    [`WEAPON_2011`] ='9x19mm Parabellum',
    [`WEAPON_HUNTINGRIFLE`] = '.50 BMG',
    [`WEAPON_NSR9`] = '7.76x51mm NATO', 
    [`WEAPON_X19`] = '9x19mm Parabellum',
    [`WEAPON_GANG1`] = '9x19mm Parabellum',
    [`WEAPON_GANG2`] = '9x19mm Parabellum',
    [`WEAPON_GANG3`] = '9x19mm Parabellum',
    [`WEAPON_GANG4`] = '9x19mm Parabellum',
    [`WEAPON_GANG5`] = '9x19mm Parabellum',
    [`WEAPON_GANG6`] = '9x19mm Parabellum',
    [`WEAPON_GANG7`] = '9x19mm Parabellum',
    [`WEAPON_GANG8`] = '9x19mm Parabellum',
    [`WEAPON_GANG9`] = '9x19mm Parabellum',
    [`WEAPON_GANG10`] = '9x19mm Parabellum',
    [`WEAPON_M320b`] = '9x19mm Parabellum',
    [`WEAPON_HK416B`] = '7.76x51mm NATO', 
    [`WEAPON_KVR`] = '9x19mm Parabellum', 
    [`WEAPON_MK18`] = '7.76x51mm NATO', 
    [`WEAPON_G19XCUSTOM`] = '9x19mm Parabellum',
    [`WEAPON_G19XBLACK`] = '9x19mm Parabellum',
    [`WEAPON_MI9`] = '9x19mm Parabellum',
    [`WEAPON_X17`] = '9x19mm Parabellum',
    [`WEAPON_AGC`] = '9x19mm Parabellum',
    [`WEAPON_TECPISTOL`] ='9x19mm Parabellum',
    [`WEAPON_A45`] ='9x19mm Parabellum',
    [`WEAPON_BATTLERIFLE`] = '7.76x51mm NATO', 
    [`WEAPON_C36`]  = '7.76x51mm NATO', 
    [`WEAPON_MCXSPEAR`] = '7.76x51mm NATO', 
    [`WEAPON_P5`] = '9x19mm Parabellum',
    [`WEAPON_RFB`]= '7.76x51mm NATO', 
    [`WEAPON_PM4`] = '7.76x51mm NATO',  
    [`weapon_virtus_4`] = '7.76x51mm NATO',
    [`weapon_mutant_long`] = '7.76x51mm NATO',
    [`WEAPON_MB47`] = '7.76x51mm NATO',   
    [`WEAPON_RATREV`] = '9x19mm Parabellum',
}
