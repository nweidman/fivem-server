...
Config.OnlyShowPlateIfLocked = true -- If true, the plate will only be showed if we have a lock on the vehicle.
...
Config.ThermalOptions = {
    MaxThickness = 10.0, -- 1.0 = Default GTA, can't see trough much at all. 20.0 = Able to see trough most thin walls, however won't be able to see trough the ground or multiple/thick walls.
...
Config.ShowInstructions = true -- If true, instructions will be showns while you are in the camera
...
Config.Helicopters = {
    ...
    [`polmav_killer`] = {
        offset = vector3(0.0, 3.38, -1.1),
        nightvision = true,
        thermalvision = true,
        spotlight = true,
        passengerOnly = false,
        disableRapelling = false,
        labels = {
