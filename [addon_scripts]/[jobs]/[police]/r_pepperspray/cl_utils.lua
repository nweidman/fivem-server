...
elseif Config.AcePermission.enabled then
    TriggerServerEvent('ryt:r_pepperspray:acePermission', Config.AcePermission.permission)
end

RegisterNetEvent('ryt:r_pepperspray:returnAcePermission')
AddEventHandler('ryt:r_pepperspray:returnAcePermission', function()
    allowAce = true
end)
