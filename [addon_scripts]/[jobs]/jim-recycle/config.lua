...
Config = {
	...
	ScrapyardSearching = {
		Enable = false,
		searched = { }, -- No Touch
		skillcheck = "ox_lib", --"qb-lock", "ps-ui", "ox_lib", "ox_lib", nil
	...
	DumpsterDiving = {
		Enable = false,
		searched = { }, -- No Touch
		skillcheck = "ps-ui", --"qb-lock", "ps-ui", "ox_lib", "ox_lib", nil
		models = { -- The mighty list of dumpters/trash cans
	...
	PayAtDoor = 0, -- Set to nil stop turn this off, set to a number to enable
	...
	RecycleAmounts = {
		...
		["Trade"] = {
			{ amount = 10, itemGive = 3, Min = 2, Max = 2, },
			{ amount = 100, itemGive = 7, Min = 9, Max = 12, },
		},
	}
}
