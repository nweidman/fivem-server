...
const AVAILABLE_JOBS = [
  {
    job: 'police',
    templateGrades: [3, 4],
    logo: 'https://static.wikia.nocookie.net/nopixel/images/2/2a/LSPD4.png/revision/latest?cb=20240105225245',
  },
  {
    job: 'ambulance',
    templateGrades: [3],
  ...
  },
  {
    job: 'doj',
    templateGrades: [4],
    logo: 'https://www.google.com/url?sa=i&url=https%3A%2F%2Fnopixel.fandom.com%2Fwiki%2FDepartment_of_Justice&psig=AOvVaw3Vlpea786JfzmX87ibNgi-&ust=1759808356253000&source=images&cd=vfe&opi=89978449&ved=0CBMQjRxqFwoTCPjtqZHTjpADFQAAAAAdAAAAABAE',
  },
]
