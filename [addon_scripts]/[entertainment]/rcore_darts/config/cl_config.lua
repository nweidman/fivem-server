...
CConfig.TargetName = 'ox_target' -- Name of the target resource (They are compatible)
...
CConfig.DoubleToWin = false -- If you want a more realistic game using real rules
