...
local qbJobAreaControllers = { -- QB jobs that can access /hall is specific areas.
    -- ['vanilla'] = { -- Remove this to disable it, or add more entries as you wish.
    --     {'vanilla', 3}, -- QB "unicorn" job with 2 grade level can access "vanilla_unicorn" area.
    --     {'vanilla', 4},
    --     {'vanilla', 5},
    --     'dj' -- QB "dj" job can access /hall regardless of grade level.
    -- },
    ['pdm'] = { -- Remove this to disable it, or add more entries as you wish.
        {'pdm', 2},
        {'pdm', 3},
        {'pdm', 4},
        {'pdm', 5},
    ...
    ['lux'] = { -- Remove this to disable it, or add more entries as you wish.
        {'lux', 2},
        {'lux', 3},
        {'lux', 4},
        {'lux', 5},
    ...
    ['badlands'] = { -- Remove this to disable it, or add more entries as you wish.
        {'badlands', 2},
        {'badlands', 3},
        {'badlands', 4},
        {'badlands', 5},
    ...
    ['photo'] = { -- Remove this to disable it, or add more entries as you wish.
        {'photo', 0},
        {'photo', 1},
        {'photo', 2},
        {'photo', 3},
    ...
    ['lscustoms'] = { -- Remove this to disable it, or add more entries as you wish.
        {'lscustoms', 3},
        {'lscustoms', 4},
        {'lscustoms', 5},
        'dj' -- QB "dj" job can access /hall regardless of grade level.
    },
    ['ccm'] = { -- Remove this to disable it, or add more entries as you wish.
        {'ccm', 3},
        {'ccm', 4},
        {'ccm', 5},
        'dj' -- QB "dj" job can access /hall regardless of grade level.
    },
    ['stance'] = { -- Remove this to disable it, or add more entries as you wish.
        {'saltlabsmoothies', 2},
        {'saltlabsmoothies', 3},
        {'saltlabsmoothies', 4},
        {'stance', 3},
    ...
    ['moo'] = { -- Remove this to disable it, or add more entries as you wish.
        {'moo', 0},
        {'moo', 1},
        {'moo', 2},
        {'moo', 3},
    ...
    ['lilypad'] = { -- Remove this to disable it, or add more entries as you wish. hornys
        {'lilypad', 1},
        {'lilypad', 2},
        {'lilypad', 3},
        {'lilypad', 4},
    ...
    ['highnote'] = { -- Remove this to disable it, or add more entries as you wish.
        {'highnote', 0},
        {'highnote', 1},
        {'highnote', 2},
        {'highnote', 3},
   ...
   ['smoking'] = { -- Remove this to disable it, or add more entries as you wish.
        {'smoking', 1},
        {'smoking', 2},
        {'smoking', 3},
        {'smoking', 4},
   ...
   ['pitapan'] = { -- Remove this to disable it, or add more entries as you wish. hornys
        {'pitapan', 2},
        {'pitapan', 3},
        {'pitapan', 4},
        'dj' -- QB "dj" job can access /hall regardless of grade level.
    },
    ['esm'] = { -- Remove this to disable it, or add more entries as you wish.
        {'esm', 3},    
        {'esm', 4},
        {'esm', 5},
        'dj' -- QB "dj" job can access /hall regardless of grade level.
    },
    ['ss'] = { -- Remove this to disable it, or add more entries as you wish.
       {'ss', 2},    
       {'ss', 3},
       {'ss', 4},
    'dj' -- QB "dj" job can access /hall regardless of grade level.
    },
    ['bahama'] = { -- Remove this to disable it, or add more entries as you wish.
        {'bahama', 3},
        {'bahama', 4},
        {'bahama', 5},
        'dj' -- QB "dj" job can access /hall regardless of grade level.
    },
    ['boathouse'] = { -- Remove this to disable it, or add more entries as you wish.
        {'boathouse', 2},
        {'boathouse', 3},
        {'boathouse', 4},
        'dj' -- QB "dj" job can access /hall regardless of grade level.
    },
    ['smallclaimscourt'] = { -- Remove this to disable it, or add more entries as you wish.
        {'doj', 0},
        {'doj', 1},
        {'doj', 2},
        {'doj', 3},
   ...
   ['largecourt'] = { -- Remove this to disable it, or add more entries as you wish.
        {'doj', 0},
        {'doj', 1},
        {'doj', 2},
        {'doj', 3},
...
RegisterNetEvent('cs-hall:integration:toggleControllerInterface', function(area)
    ...
    if (CanAccessControllerInterface(source, area)) then
        ...
        if (config.debug) then
            print('[debug] hall inaccessible (no access)', source, area)
        end
...
AddEventHandler('cs-hall:onPlay', function(area, bucketId, source, data)
...
AddEventHandler('cs-hall:onPause', function(area, bucketId, source, data)
...
AddEventHandler('cs-hall:onStop', function(area, bucketId, source, data)
...
AddEventHandler('cs-hall:onDuration', function(area, bucketId, source, duration)
...
AddEventHandler('cs-hall:onEntryQueued', function(area, bucketId, source, data)
...
AddEventHandler('cs-hall:onEntryRemoved', function(area, bucketId, source, data)
...
--[[
    bucketId = The bucket ID of the game we want to target, use 0 if you are not using buckets (0 is the game's default bucket).

    exports['cs-hall']:Play(area, bucketId)                               -- Trigger a play action in the specified area. The area is the config entry's key.
    exports['cs-hall']:Pause(area, bucketId)                              -- Trigger a pause action in the specified area. The area is the config entry's key.
    exports['cs-hall']:Stop(area, bucketId)                               -- Trigger a stop action in the specified area. The area is the config entry's key.
    exports['cs-hall']:IsPlaying(area, bucketId)                          -- Returns whether an entry is playing in the specified area. The area is the config entry's key.
    exports['cs-hall']:SetLoop(area, bucketId, state)                     -- Sets the player loop state of the specified area. The area is the config entry's key. The state is a boolean indicating the loop state.
    ...
    exports['cs-hall']:QueueNow(area, bucketId, position)                 -- Queues an entry to the specified area's queue in the specified queue position. The area is the config entry's key.
    exports['cs-hall']:RemoveFromQueue(area, bucketId, position)          -- Removes an entry from the specified area's queue in the specified queue position. The area is the config entry's key.

    exports['cs-hall']:GetPlayer(area, bucketId)                          -- Returns the entry in the player of the specified area in an object with the following data structure.
                                                                {
    ...
    exports['cs-hall']:GetQueue(area, bucketId)                           -- Returns the queue of the specified area in an array of objects with the following data structure for each object.
                                                                {
                                                                    url,                -- The URL of the entry (as received via a client or an export).
                                                                    thumbnailUrl,       -- The thumbnail URL of the entry (as received via a client or an export).
                                                                    thumbnailTitle,     -- The thumbnail title of the entry (as received via a client or an export).
