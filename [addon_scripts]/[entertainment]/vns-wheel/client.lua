...
Citizen.CreateThread(function()
	...
	if Config.K4MB1_Casino_Map == true then
		local o = GetClosestObjectOfType(964.36, 49.45, 81.52, 2.5, GetHashKey('ch_prop_casino_lucky_wheel_01a'), 1 ,0 , 0)
		local o1 = GetClosestObjectOfType(964.36, 49.45, 81.52, 2.5, GetHashKey('ch_prop_casino_lucky_wheel_01a'), 1 ,0 , 0)
		local o2 = GetClosestObjectOfType(964.36, 49.45, 81.52, 2.5, GetHashKey('ch_prop_casino_lucky_wheel_01a'), 1 ,0 , 0)
...
Citizen.CreateThread(function()
	while true do
        ...
        if(GetDistanceBetweenCoords(coords, _wheelPos.x, _wheelPos.y, _wheelPos.z, true) < 1.5) and not _isRolling then
            helpText('Press ~INPUT_CONTEXT~ to spin the Lucky Wheel')
