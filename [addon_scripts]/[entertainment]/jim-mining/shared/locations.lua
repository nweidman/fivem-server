Locations = {
    ["Washing"] = {
        ...
        positions = {
            ...
            { name = "Stone Washing", coords = vec3(1870.91, 395.1, 160.16), sprite = 467, col = 3, disp = 6, blipEnable = true },
            -- { name = "Stone Washing", coords = vec3(-432.59, 2936.84, 13.87), sprite = 467, col = 3, disp = 6, blipEnable = true }, -- Stream Blip
            -- { name = "Stone Washing", coords = vec3(-422.37, 2946.18, 13.77), sprite = 467, col = 3, blipEnable = true },
            -- { name = "Stone Washing", coords = vec3(-443.21, 2926.5, 13.62), sprite = 467, col = 3, blipEnable = true },
            -- { name = "Stone Washing", coords = vec3(-455.48, 2917.16, 13.52), sprite = 467, col = 3, blipEnable = true },
            ...
            { name = "Stone Washing", coords = vec3(894.14, 4386.56, 30.24), sprite = 467, col = 3, blipEnable = true },
            { name = "Stone Washing", coords = vec3(893.12, 4370.74, 30.35), sprite = 467, col = 3, blipEnable = true },
            { name = "Stone Washing", coords = vec3(912.88, 4365.7, 30.39), sprite = 467, col = 3, blipEnable = true },
        },
    },
    ["Panning"] = {
        Enable = true,
        positions = {
            ...
            ["Wilderness"] = {
                ...
                Blip = { -- The location where you enter the mine
                    Enable = true,
                    name = "Gold Panning",
                    coords = vec3(-1620.45, 4442.21, 0.47),
                    sprite = 467, col = 5,
                },
                Positions = {
                    { coords = vec4(-1614.78, 4432.63, 0.49, 206.3), w = 10.9, d = 6.0 },
                    { coords = vec4(-1621.5, 4451.48, 0.38, 49.21), w = 24.3, d = 6.0 },
                }
            },
        },
    },
