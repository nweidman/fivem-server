Crafting = {
	SmeltMenu = {
		...
		Recipes = {
			...
			{ ["goldbar"] = { ["goldore"] = 5 }, ['amount'] = 1 },
			-- { ["goldingot"] = { ["goldchain"] = 3 } },
			-- { ["goldingot"] = { ["gold_ring"] = 4 } },
			-- { ["silveringot"] = { ["silverore"] = 1 }, ['amount'] = 1 },
			-- { ["silveringot"] = { ["silverchain"] = 3 } },
			-- { ["silveringot"] = { ["silver_ring"] = 4 } },
			{ ["sulfur"] = { ["sulfurore"] = 1 }, ['amount'] = 1 },
			{ ["iron"] = { ["ironore"] = 1 }, ['amount'] = 2 },
			{ ["steel"] = { ["ironore"] = 1, ["carbon"] = 1 }, ['amount'] = 1 },
			{ ["aluminum"] = { ["can"] = 1, }, ['amount'] = 1 },
			{ ["metalscrap"] = { ["bottle"] = 1, }, ['amount'] = 1 },
		},
	},
	GemCut = {
	...
	EarCut = {
		...
		anims = { anim = "operate_02_hi_amy_skater_01", animDict = "anim@amb@machinery@speed_drill@" },
		Recipes = {
			{ ["goldearring"] = { ["goldore"] = 1 }, ['amount'] = 1  },
