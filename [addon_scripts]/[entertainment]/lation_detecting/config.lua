...
Config.Shops = {
    detectors = {
        ...
        coords = vec4(2074.5637, 3944.8608, 32.6659, 120.2841),
...
Config.Detectors = {
    [1] = { -- Level required to purchase this detector
        ...
        price = 3000, -- How much this metal detector costs in shop
        prop = 'blue_metaldetector', -- Prop
        item = 'blue_metaldetector', -- Item name
        radius = 15, -- How far it can detect items
        cooldown = math.random(15000, 30000), -- How often an item can be found
        loot = { -- All loot available with this detector
            ...
            ['can'] = {chance = 50, quantity = { min = 1, max = 2 }, addXP = 350},
            ['aluminum'] = {chance = 50, quantity = { min = 1, max = 2 }, addXP = 350},
            ['goldchain'] = {chance = 50, quantity = { min = 1, max = 2 }, addXP = 350},
            ['rolex'] = {chance = 50, quantity = { min = 1, max = 2 }, addXP = 350},
            ['tenkgoldchain'] = {chance = 50, quantity = { min = 1, max = 2 }, addXP = 350},
            ['sapphire'] = {chance = 50, quantity = { min = 1, max = 2 }, addXP = 350},
            ['ruby'] = {chance = 50, quantity = { min = 1, max = 2 }, addXP = 350},
            ['emerald'] = {chance = 50, quantity = { min = 1, max = 2 }, addXP = 350},
            ['diamond_ring'] = {chance = 50, quantity = { min = 1, max = 2 }, addXP = 350},
            ['diamond_necklace'] = {chance = 50, quantity = { min = 1, max = 2 }, addXP = 350},
            ['diamond'] = {chance = 50, quantity = { min = 1, max = 2 }, addXP = 350},
            ['lockpick'] = {chance = 35, quantity = { min = 1, max = 1 }, addXP = 550},
            ['advancedlockpick'] = {chance = 15, quantity = { min = 1, max = 1 }, addXP = 550},
            ['radio'] = {chance = 10, quantity = { min = 1, max = 1 }, addXP = 550},
            ['phone'] = {chance = 10, quantity = { min = 1, max = 1 }, addXP = 550},
            ['blowtorch'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 550},
            ['weapon_wrench'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 550},
            ['cryptostick'] = {chance = 35, quantity = { min = 1, max = 2 }, addXP = 350},
            ['stone'] = {chance = 10, quantity = { min = 1, max = 2 }, addXP = 350},
            ['copper'] = {chance = 5, quantity = { min = 1, max = 2 }, addXP = 350},
            ['iron'] = {chance = 5, quantity = { min = 1, max = 2 }, addXP = 350},
            ['steel'] = {chance = 5, quantity = { min = 1, max = 2 }, addXP = 350},
            ['metalscrap'] = {chance = 5, quantity = { min = 1, max = 2 }, addXP = 350},
            ['aluminum'] = {chance = 5, quantity = { min = 1, max = 2 }, addXP = 350},
            ['ls_auto_parts'] = {chance = 10, quantity = { min = 1, max = 2 }, addXP = 350},
            ['cryptoharddrive'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 350},
            ['pistol_ammo'] = {chance = 20, quantity = { min = 1, max = 16 }, addXP = 350},
            ['pistolparts'] = {chance = 10, quantity = { min = 2, max = 3 }, addXP = 750},
            -- ['mysterybag'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 750},
            -- ['partsmysterybox'] = {chance = 3, quantity = { min = 1, max = 1 }, addXP = 750},
            -- ['handcuffs'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 750},
            -- ['shotgunbody'] = {chance = 3, quantity = { min = 1, max = 1 }, addXP = 1000},
            -- ['shotgunbarrel'] = {chance = 3, quantity = { min = 1, max = 1 }, addXP = 1000},
            -- ['smgbody'] = {chance = 2, quantity = { min = 1, max = 1 }, addXP = 1500},
            -- ['smggrip'] = {chance = 2, quantity = { min = 1, max = 1 }, addXP = 1500},
            -- ['smgbarrel'] = {chance = 2, quantity = { min = 1, max = 1 }, addXP = 1500},
            -- ['riflebody'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 2000},
            -- ['riflebarrel'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 2000},
            -- ['riflegrip'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 2000},
            -- ['riflemagazine'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 2000},
            -- ['riflestock'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 2000},
            -- ['weapon_pistol50'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 3000},
            -- ['handcuffs'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 150},
            -- ['shotgunbody'] = {chance = 3, quantity = { min = 1, max = 1 }, addXP = 150},
            -- ['shotgunbarrel'] = {chance = 3, quantity = { min = 1, max = 1 }, addXP = 150},
            -- ['smgbody'] = {chance = 2, quantity = { min = 1, max = 1 }, addXP = 150},
            -- ['smggrip'] = {chance = 2, quantity = { min = 1, max = 1 }, addXP = 150},
            -- ['smgbarrel'] = {chance = 2, quantity = { min = 1, max = 1 }, addXP = 150},
            -- ['riflebody'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 150},
            -- ['riflebarrel'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 150},
            -- ['riflegrip'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 150},
            -- ['riflemagazine'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 150},
            -- ['riflestock'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 150},
            -- ['weapon_pistol50'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 150},
        }
    },
    [2] = { -- Level 2
        requiredXP = 15000,
        ...
        loot = {
            ['can'] = {chance = 50, quantity = { min = 1, max = 3 }, addXP = 350},
            ['aluminum'] = {chance = 50, quantity = { min = 1, max = 3 }, addXP = 350},
            ['goldchain'] = {chance = 50, quantity = { min = 1, max = 3 }, addXP = 350},
            ['rolex'] = {chance = 50, quantity = { min = 1, max = 3 }, addXP = 350},
            ['tenkgoldchain'] = {chance = 50, quantity = { min = 1, max = 3 }, addXP = 350},
            ['sapphire'] = {chance = 50, quantity = { min = 1, max = 3 }, addXP = 350},
            ['ruby'] = {chance = 50, quantity = { min = 1, max = 3 }, addXP = 350},
            ['emerald'] = {chance = 50, quantity = { min = 1, max = 3 }, addXP = 350},
            ['diamond_ring'] = {chance = 50, quantity = { min = 1, max = 3 }, addXP = 350},
            ['diamond_necklace'] = {chance = 50, quantity = { min = 1, max = 3 }, addXP = 350},
            ['diamond'] = {chance = 50, quantity = { min = 1, max = 3 }, addXP = 350},
            ['lockpick'] = {chance = 35, quantity = { min = 1, max = 1 }, addXP = 550},
            ['advancedlockpick'] = {chance = 15, quantity = { min = 1, max = 1 }, addXP = 550},
            ['radio'] = {chance = 10, quantity = { min = 1, max = 1 }, addXP = 550},
            ['phone'] = {chance = 10, quantity = { min = 1, max = 1 }, addXP = 550},
            ['blowtorch'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 550},
            ['weapon_wrench'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 550},
            ['cryptostick'] = {chance = 35, quantity = { min = 1, max = 3 }, addXP = 350},
            ['stone'] = {chance = 10, quantity = { min = 1, max = 3 }, addXP = 350},
            ['copper'] = {chance = 5, quantity = { min = 1, max = 3 }, addXP = 350},
            ['iron'] = {chance = 5, quantity = { min = 1, max = 3 }, addXP = 350},
            ['steel'] = {chance = 5, quantity = { min = 1, max = 3 }, addXP = 350},
            ['metalscrap'] = {chance = 5, quantity = { min = 1, max = 3 }, addXP = 350},
            ['aluminum'] = {chance = 5, quantity = { min = 1, max = 3 }, addXP = 350},
            ['ls_auto_parts'] = {chance = 10, quantity = { min = 1, max = 3 }, addXP = 350},
            ['cryptoharddrive'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 350},
            ['pistol_ammo'] = {chance = 20, quantity = { min = 1, max = 30 }, addXP = 350},
            ['pistolparts'] = {chance = 10, quantity = { min = 3, max = 4 }, addXP = 750},
            ['mysterybag'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 750},
            ['partsmysterybox'] = {chance = 3, quantity = { min = 1, max = 1 }, addXP = 750},
            -- ['handcuffs'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 750},
            -- ['shotgunbody'] = {chance = 3, quantity = { min = 1, max = 1 }, addXP = 1000},
            ...
            -- ['riflestock'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 150},
            -- ['weapon_pistol50'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 150},
            -- ['weapon_pistol50'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 750},
            -- ['weaponparts'] = {chance = 1, quantity = { min = 1, max = 3 }, addXP = 1200},
            -- ['mysterybox'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 1200},
            -- ['handcuffs'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 1200},
    ...
    [3] = { -- Level 3
        ...
        cooldown = math.random(15000, 30000),
        loot = {
            ['can'] = {chance = 50, quantity = { min = 2, max = 3 }, addXP = 350},
            ['aluminum'] = {chance = 50, quantity = { min = 2, max = 3 }, addXP = 350},
            ['goldchain'] = {chance = 50, quantity = { min = 2, max = 3 }, addXP = 350},
            ['rolex'] = {chance = 50, quantity = { min = 2, max = 3 }, addXP = 350},
            ['tenkgoldchain'] = {chance = 50, quantity = { min = 2, max = 3 }, addXP = 350},
            ['sapphire'] = {chance = 50, quantity = { min = 2, max = 3 }, addXP = 350},
            ['ruby'] = {chance = 50, quantity = { min = 2, max = 3 }, addXP = 350},
            ['emerald'] = {chance = 50, quantity = { min = 2, max = 3 }, addXP = 350},
            ['diamond_ring'] = {chance = 50, quantity = { min = 2, max = 3 }, addXP = 350},
            ['diamond_necklace'] = {chance = 50, quantity = { min = 2, max = 3 }, addXP = 350},
            ['diamond'] = {chance = 50, quantity = { min = 2, max = 3 }, addXP = 350},
            ['lockpick'] = {chance = 35, quantity = { min = 1, max = 1 }, addXP = 550},
            ['advancedlockpick'] = {chance = 15, quantity = { min = 1, max = 1 }, addXP = 550},
            ['radio'] = {chance = 10, quantity = { min = 1, max = 1 }, addXP = 550},
            ['phone'] = {chance = 10, quantity = { min = 1, max = 1 }, addXP = 550},
            ['blowtorch'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 550},
            ['weapon_wrench'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 550},
            ['cryptostick'] = {chance = 35, quantity = { min = 2, max = 3 }, addXP = 350},
            ['stone'] = {chance = 10, quantity = { min = 2, max = 3 }, addXP = 350},
            ['copper'] = {chance = 5, quantity = { min = 2, max = 3 }, addXP = 350},
            ['iron'] = {chance = 5, quantity = { min = 2, max = 3 }, addXP = 350},
            ['steel'] = {chance = 5, quantity = { min = 2, max = 3 }, addXP = 350},
            ['metalscrap'] = {chance = 5, quantity = { min = 2, max = 3 }, addXP = 350},
            ['aluminum'] = {chance = 5, quantity = { min = 2, max = 3 }, addXP = 350},
            ['ls_auto_parts'] = {chance = 10, quantity = { min = 1, max = 2 }, addXP = 350},
            ['cryptoharddrive'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 350},
            ['pistol_ammo'] = {chance = 20, quantity = { min = 30, max = 30 }, addXP = 350},
            ['pistolparts'] = {chance = 10, quantity = { min = 3, max = 5 }, addXP = 750},
            ['mysterybag'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 750},
            ['partsmysterybox'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 750},
            ['handcuffs'] = {chance = 3, quantity = { min = 1, max = 1 }, addXP = 750},
            ['shotgunbody'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 1000},
            ['shotgunbarrel'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 1000},
            -- ['smgbody'] = {chance = 2, quantity = { min = 1, max = 1 }, addXP = 1500},
            -- ['smggrip'] = {chance = 2, quantity = { min = 1, max = 1 }, addXP = 1500},
            -- ['smgbarrel'] = {chance = 2, quantity = { min = 1, max = 1 }, addXP = 1500},
            -- ['riflebody'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 2000},
    ...
    [4] = { -- Level 4
        ...
        radius = 45,
        cooldown = math.random(15000, 40000),
        loot = {
            ['can'] = {chance = 50, quantity = { min = 2, max =4 }, addXP = 350},
            ['aluminum'] = {chance = 50, quantity = { min = 2, max = 4 }, addXP = 350},
            ['goldchain'] = {chance = 50, quantity = { min = 2, max = 4 }, addXP = 350},
            ['rolex'] = {chance = 50, quantity = { min = 2, max = 4 }, addXP = 350},
            ['tenkgoldchain'] = {chance = 50, quantity = { min = 2, max = 4 }, addXP = 350},
            ['sapphire'] = {chance = 50, quantity = { min = 2, max = 4 }, addXP = 350},
            ['ruby'] = {chance = 50, quantity = { min = 2, max = 4 }, addXP = 350},
            ['emerald'] = {chance = 50, quantity = { min = 2, max = 4 }, addXP = 350},
            ['diamond_ring'] = {chance = 50, quantity = { min = 2, max = 4 }, addXP = 350},
            ['diamond_necklace'] = {chance = 50, quantity = { min = 2, max = 4 }, addXP = 350},
            ['diamond'] = {chance = 50, quantity = { min = 2, max = 4 }, addXP = 350},
            ['lockpick'] = {chance = 35, quantity = { min = 1, max = 1 }, addXP = 550},
            ['advancedlockpick'] = {chance = 15, quantity = { min = 1, max = 1 }, addXP = 550},
            ['radio'] = {chance = 10, quantity = { min = 1, max = 1 }, addXP = 550},
            ['phone'] = {chance = 10, quantity = { min = 1, max = 1 }, addXP = 550},
            ['blowtorch'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 550},
            ['weapon_wrench'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 550},
            ['cryptostick'] = {chance = 35, quantity = { mmin = 4, max = 5 }, addXP = 350},
            ['stone'] = {chance = 10, quantity = { min = 2, max = 4 }, addXP = 350},
            ['copper'] = {chance = 5, quantity = { min = 2, max = 4 }, addXP = 350},
            ['iron'] = {chance = 5, quantity = { min = 2, max = 4 }, addXP = 350},
            ['steel'] = {chance = 5, quantity = { min = 2, max = 4 }, addXP = 350},
            ['metalscrap'] = {chance = 5, quantity = { min = 2, max = 4 }, addXP = 350},
            ['aluminum'] = {chance = 5, quantity = { min = 2, max = 4 }, addXP = 350},
            ['ls_auto_parts'] = {chance = 10, quantity = { min = 2, max = 4 }, addXP = 350},
            ['cryptoharddrive'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 350},
            ['pistol_ammo'] = {chance = 20, quantity = { min = 15, max = 60 }, addXP = 350},
            ['pistolparts'] = {chance = 10, quantity = { min = 3, max = 8 }, addXP = 750},
            ['mysterybag'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 750},
            ['partsmysterybox'] = {chance = 3, quantity = { min = 1, max = 1 }, addXP = 750},
            ['handcuffs'] = {chance = 3, quantity = { min = 1, max = 1 }, addXP = 750},
            ['shotgunbody'] = {chance = 2, quantity = { min = 1, max = 1 }, addXP = 1000},
            ['shotgunbarrel'] = {chance = 2, quantity = { min = 1, max = 1 }, addXP = 1000},
            ['smgbody'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 1500},
            ['smggrip'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 1500},
            ['smgbarrel'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 1500},
            -- ['riflebody'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 2000},
            -- ['riflebarrel'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 2000},
            -- ['riflegrip'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 2000},
            -- ['riflemagazine'] = {chance = 1, quantity = { min = 1, max = 1 }, addXP = 2000},
    ...
    [5] = { -- Level 5
        ...
        cooldown = math.random(15000, 40000),
        loot = {
            ['can'] = {chance = 50, quantity = { min = 3, max = 5 }, addXP = 350},
            ['aluminum'] = {chance = 50, quantity = { min = 3, max = 5 }, addXP = 350},
            ['goldchain'] = {chance = 50, quantity = { min = 3, max = 5 }, addXP = 350},
            ['rolex'] = {chance = 50, quantity = { min = 3, max = 5 }, addXP = 350},
            ['tenkgoldchain'] = {chance = 50, quantity = { min = 3, max = 5 }, addXP = 350},
            ['sapphire'] = {chance = 50, quantity = { min = 3, max = 5 }, addXP = 350},
            ['ruby'] = {chance = 50, quantity = { min = 3, max = 5 }, addXP = 350},
            ['emerald'] = {chance = 50, quantity = { min = 3, max = 5 }, addXP = 350},
            ['diamond_ring'] = {chance = 50, quantity = { min = 3, max = 5 }, addXP = 350},
            ['diamond_necklace'] = {chance = 50, quantity = { min = 3, max = 5 }, addXP = 350},
            ['diamond'] = {chance = 50, quantity = { min = 3, max = 5 }, addXP = 350},
            ['lockpick'] = {chance = 35, quantity = { min = 1, max =1 }, addXP = 550},
            ['advancedlockpick'] = {chance = 15, quantity = { min = 1, max = 1 }, addXP = 550},
            ['radio'] = {chance = 10, quantity = { min = 1, max = 1 }, addXP = 550},
            ['phone'] = {chance = 10, quantity = { min = 1, max = 1 }, addXP = 550},
            ['blowtorch'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 550},
            ['weapon_wrench'] = {chance = 5, quantity = { min =1, max = 1 }, addXP = 550},
            ['cryptostick'] = {chance = 35, quantity = { min = 3, max = 5 }, addXP = 350},
            ['stone'] = {chance = 10, quantity = { min = 3, max = 5 }, addXP = 350},
            ['copper'] = {chance = 6, quantity = { min = 3, max = 5 }, addXP = 350},
            ['iron'] = {chance = 6, quantity = { min = 3, max = 5 }, addXP = 350},
            ['steel'] = {chance = 6, quantity = { min = 3, max = 5 }, addXP = 350},
            ['metalscrap'] = {chance = 6, quantity = { min = 3, max = 5 }, addXP = 350},
            ['aluminum'] = {chance = 6, quantity = { min = 3, max = 5 }, addXP = 350},
            ['ls_auto_parts'] = {chance = 10, quantity = { min = 3, max = 5 }, addXP = 350},
            ['cryptoharddrive'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 350},
            ['pistol_ammo'] = {chance = 20, quantity = { min = 30, max = 75 }, addXP = 350},
            ['pistolparts'] = {chance = 10, quantity = { min = 5, max = 8 }, addXP = 750},
            ['mysterybag'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 750},
            ['partsmysterybox'] = {chance = 4, quantity = { min = 1, max = 1 }, addXP = 750},
            ['heistmysterybox'] = {chance = 3, quantity = { min = 1, max = 1 }, addXP = 750},
            ['handcuffs'] = {chance = 5, quantity = { min = 1, max = 1 }, addXP = 750},
            ['shotgunbody'] = {chance = 3, quantity = { min = 1, max = 1 }, addXP = 1000},
            ['shotgunbarrel'] = {chance = 3, quantity = { min = 1, max = 1 }, addXP = 1000},
            ['smgbody'] = {chance = 2, quantity = { min = 1, max = 1 }, addXP = 1500},
