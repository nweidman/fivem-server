Config = {
    ...
    LUCKY_WHEEL_COOLDOWN = (60 * 60 * 18), -- how long players have to wait for their next spin. def: 24 hours (60 * 60 * 24)
    ...
    ForceNormalKeyLabels = true, -- whether to replace blip icon codes ([E]) with text ([E], [F], [G], etc.)
