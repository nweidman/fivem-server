Translation["en"] = {
    ...
    BAR_ASK_SHOT = "Press [E] to ask for one shot. Press ~INPUT_CELLPHONE_CANCEL~ to leave",
    ...
    BAR_PRESS_TO_ORDER = "Press [E] to order a drink",
    BAR_PRESS_TO_SIT_DOWN = "Press [E] to sit down",
    BAR_SIT_FUNCTIONS = "Press [E] to use your casino snacks\nPress ~INPUT_CELLPHONE_CANCEL~ to leave your chair",
    ...
    UI_PRESS_TO_PLAY = "Press [E] to play",
    ...
    SLOTS_PRESS_TO_PLAY = "Press [E] to play %s.",
    ...
    IT_PRESS_TO_PLAY = "Press [E] to play Inside Track.",
    ...
    WHEEL_PRESS_BROKEN_2 = "The Lucky Wheel disk holder broke and fell off. Press [E] to start the repair.",
    ...
    WHEEL_CHOOSE_STRENGTH = "Press [E] to spin at your desired speed",
    WHEEL_BEING_USED = "Lucky Wheel is being controlled by another player",
    WHEEL_PRESS_TO_PLAY = "Press [E] to spin the Lucky Wheel",
    ...
    CASHIER_PRESS_TO_USE = "Press [E] to say Hi.",
    ...
    SEATING_PRESS_TO_SIT = "Press [E] to sit down",
    ...
    BOSS_PRESS_TO_USE_COMPUTER = "Press [E] to sit down and access the Casino cameras",
    BOSS_PRESS_TO_USE_ELEVATOR = "Press [E] to use the elevator",
    BOSS_SITTING_OPTIONS = "Press [E] to use the Casino computer. Press ~INPUT_CELLPHONE_CANCEL~ to stand up",
    ...
    PRESS_TO_LEAVE_CASINO = "Press [E] to leave the Diamond Casino.",
    PRESS_TO_ENTER_CASINO = "Press [E] to enter the Diamond Casino.",
    CASHIER_TRANSFER_INFO = "%s casino chips equal to %s! ",
    CASHIER_EXCHANGE_RATE_DESC = "Exchange Rate: 10 Chips = %s",
    WHEEL_PRESS_TO_PLAY_PAID = "Press [E] to spin the Lucky Wheel for %s Chips.",
    WHEEL_CANT_AFFORD_PLAYING = "You need %s Chips to be able to spin the Lucky Wheel.",
    WHEEL_PRESS_TO_PLAY_PAID_ITEM = "Press [E] to spin the Lucky Wheel for one ticket.",
    ...
    JOB_SLOTS_BROKEN_2 = "This slot machine got fried and needs a new circuit board. Press [E] to start the job.",
    ...
    DIAMOND_WALL_BROKE_3 = "Press [E] to fix the electricity or signal.",
    PODIUM_INFO = "The Lucky Wheel jackpot is a %s. Come over to the Lucky Wheel and try your luck!",
    PODIUM_INFO_2 = "Press [E] if you wish to replace the Lucky Wheel jackpot.",
    PODIUM_INFO_3 = "The Lucky Wheel currently doesn't offer any vehicle.",
    ...
    XMAS_PRESS_E = "Press [E] to get your Christmas gift!",
