...
machineModels[-430989390] = {
    ...
    maxBet = 125,
    jackpotLimiter = 100, -- jackpot can be hit max. once per 100 spins
    unluckyFactor = 6, -- each 5th spin will hit 0 chips no matter what, set unluckyFactor = 2 for each second spin, set to 0 to disable
    items = {{
        name = "Seven",
        value = 6250,
        ShowUpReducer = 70 -- Seven will have 100% (same) chance to hit for first time, then (-70%), 30% chance to hit second time, then (-70%), 9% chance to hit third time
...
machineModels[654385216] = {
    ...
    maxBet = 25,
    jackpotLimiter = 100, -- jackpot can be hit max. once per 100 spins
    unluckyFactor = 7, -- each 5th spin will hit 0 chips no matter what, set unluckyFactor = 2 for each second spin, set to 0 to disable
    items = {{
        name = "Seven",
        value = 1250,
        ShowUpReducer = 70 -- Seven will have 100% (same) chance to hit for first time, then (-70%), 30% chance to hit second time, then (-70%), 9% chance to hit third time
...
machineModels[1096374064] = {
    ...
    messageId = 6,
    maxBet = 500,
    jackpotLimiter = 125, -- jackpot can be hit max. once per 100 spins
    unluckyFactor = 7, -- each 5th spin will hit 0 chips no matter what, set unluckyFactor = 2 for each second spin, set to 0 to disable
    items = {{
        name = "Seven",
        value = 25000,
...
machineModels[-487222358] = {
    ...
    maxBet = 50,
    jackpotLimiter = 125, -- jackpot can be hit max. once per 100 spins
    unluckyFactor = 8, -- each 5th spin will hit 0 chips no matter what, set unluckyFactor = 2 for each second spin, set to 0 to disable
    items = {{
        name = "Seven",
        value = 1250,
        ShowUpReducer = 70 -- Seven will have 100% (same) chance to hit for first time, then (-70%), 30% chance to hit second time, then (-70%), 9% chance to hit third time
...
LuckyWheelRandomItems = {{
    inventoryName = "mysterybag", -- item (inventory) name/key, case sensitive
    title = "Mystery Bag", -- title for the Lucky Wheel reward message
    amount = 1, -- amount (random between 1 to 10)
    possibility = 80
}, {
    inventoryName = "cryptostick", -- item (inventory) name/key, case sensitive
    title = "Crypto Sticks", -- title for the Lucky Wheel reward message
    amount = {1, 50}, -- amount (random between 1 to 10)
    possibility = 20
}}
...
PokerTableDatas[0] = {
    ...
    UnluckyRound = 10 -- each 3rd round will be unlucky (high possibility that players get useless cards)
}
...
PokerTableDatas[2] = {
    ...
    UnluckyRound = 11 -- each 3rd round will be unlucky (high possibility that players get useless cards)
}
...
PokerTableDatas[3] = {
    ...
    VIP = true,
    UnluckyRound = 8 -- each 3rd round will be unlucky (high possibility that players get useless cards)
}
...
BlackjackTableDatas[0] = {
    ...
    MinimumBet = 500,
    MaximumBet = 25000,
    DealerBlackjackPossibility = 10, -- 25% chance that dealer gets blackjack
...
BlackjackTableDatas[3] = {
    ...
    MaximumBet = 100000,
    VIP = true,
    DealerBlackjackPossibility = 15, -- 25% chance that dealer gets blackjack
    Dealer21Possibility = 20 -- 25% chance that dealer gets 21
}
...
BlackjackTableDatas[2] = {
    ...
    Dealer21Possibility = 10 -- 25% chance that dealer gets 21
}
...
RouletteTableDatas[0] = {
    ...
    SpinDelayMin = 5,
    SpinDelayMax = 12,
    UnluckyRound = 6, -- each 4th round spins to the unluckiest number and costs casino the least
    TriggerUnluckyRoundFrom = 15000 -- always switch to unluckiest number if the spun number costs casino more than this
}
...
RouletteTableDatas[2] = {
    ...
    SpinDelayMin = 1,
    SpinDelayMax = 1,
    UnluckyRound = 7, -- each 6th round spins to the unluckiest number and costs casino the least
    TriggerUnluckyRoundFrom = 15000 -- always switch to unluckiest number if the spun number costs casino more than this
}
...
RouletteTableDatas[3] = {
    ...
    SpinDelayMax = 12,
    VIP = true,
    UnluckyRound = 7, -- each 3rd round spins to the unluckiest number and costs casino the least
