...
AddEventHandler("Casino:SaveAmbientPeds", function(buffer)
    ...
    local fileNames = {"peddata.txt", "peddata_gabz.txt", "peddata_gabz.txt", "peddata_k4mb1.txt", "peddata_gtao.txt",
                       "0", "peddata_oldk4mb1.txt", "0", "peddata_cawles.txt", "peddata_molo.txt", "0", "peddata_atlantis.txt", "peddata_town.txt"}
...
function PrintInfo()
    ...
    local mapNames = {"DLCiplLoader", "Gabz Casino", "NoPixel Casino", "k4mb1", "GTA:O Interior",
                      "Underground Casino PALETO", "K4MB1 old enterable casino", "Patoche MLO Casino underground", "Clawles: Casino Los Santos", "Molo Casino", "Jurassic Jackpot Casino", "Atlantis Casino", "The Town Resort & Casino"}
