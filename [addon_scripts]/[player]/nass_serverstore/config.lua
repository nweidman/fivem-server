...
Config.Packages = {
	["Crown Supporter A"] = { -- Exact package name from tebex
		Items = {
			{
				model = "gstsimplisticecorche1", -- Item or account name depending on type specified below
				type = "car", -- Four types: account, item, or weapon and car
				vehicletype = "jg-advancedgarages", -- This is for your garage script, either car boat or air depending on what script you are using(Used for ESX)
			},
			{
				model = "tunak", -- Item or account name depending on type specified below
				type = "car", -- Four types: account, item, or weapon and car
				vehicletype = "jg-advancedgarages", -- This is for your garage script, either car boat or air depending on what script you are using(Used for ESX)
			},
		},
	},
	["Crown Supporter B"] = { -- Exact package name from tebex
		Items = {
			{
				model = "620gtsanim", -- Item or account name depending on type specified below
				type = "car", -- Four types: account, item, or weapon and car
				vehicletype = "jg-advancedgarages", -- This is for your garage script, either car boat or air depending on what script you are using(Used for ESX)
			},
			{
