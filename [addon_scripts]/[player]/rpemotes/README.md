...
rpemotes is a community-driven FiveM emote menu allowing players to express themselves in roleplay with custom animations, countless facial expressions, walk styles, and props.

rpemotes is free, **and will always be free**: accept no substitutes or reproductions from scummy people reselling other's hard work against agreements made with creators. We're committed to the open-source community and the dozens of contributors who put hard work into rpemotes to provide the community with free emotes and props.
...
Find our documentation [here](https://rpemotes.gitbook.io/guide)

The rpemotes resource has the following exports:
...
exports["rpemotes"]:StopPlayerProne(force) -- force is optional
exports["rpemotes"]:GetPlayerProneType() -- returns the type of prone the player is in, either "onfront" or "onback"
...
exports["rpemotes"]:setWalkstyle(name, force) -- name = "move_m@alien" or any other, force = optional bool. Lets you set or force a walk style, useful for scripts like retrieving a style before drinking and restoring it after sobering up.
...
To edit the header, find the image in the main directory of rpemotes and edit the image in your program of choice. The image dimensions are 512 x 128.
...
Having problems with users "abusing" certain walk styles? rpemotes checks if a user has an "abusable" walk style saved and clears it when a player joins. Alternatively, you can use a resource like [rpemotes-punishment](https://github.com/alberttheprince/rpemotes-punishment/) to trip players abusing these emotes.
...
- the FiveM community for using RP and updating rpemotes!
### Developers:
...
- [Manason](https://github.com/Manason) for major overhauls, refactors, and improvements of rpemotes during push to 2.0
- [CritteRo](CritteRo) for work on shared emotes placement and other refactors and fixes of rpemotes during push to 2.0
- [ChristopherM](https://github.com/cm8263) for creation of the emote placement feature and fixes of rpemotes during push to 2.0
