Config = {
    ...
    DisableCombatInMenu = true, -- Disables combat (attacking, aiming, melee) while menu is open
    ...
    MenuTitle = ' RP',
    TitleOutline = true,
    TitleColour = { R = 166, G = 113, B = 254, A = 255 },
    MenuPosition = 'right', -- 'left' / 'right'
    CustomMenuEnabled = false, -- Change the header.png to your own image
    StripRichText = true, -- Set to true if using a custom notification system that doesn't support GTA rich text formatting this removes symbols like ~ in ox_lib notifications
